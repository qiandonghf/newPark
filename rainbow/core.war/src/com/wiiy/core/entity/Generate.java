...
//		GenerateEntity.run(new File("src/com/wiiy/core/entity/Corporation.hbm.xml"));
...
//		GenerateEntity.run(new File("src/com/wiiy/core/entity/ContactAtt.hbm.xml"));
		
//		GenerateCode.run(Corporation.class);
//		GenerateCode.run("com.wiiy.core.entity");
//		GenerateCode.run(ContactAtt.class);
...
//		GenerateCode.run(UserEmailParam.class);
