...
function TabView(option) {
	...
	var tabTemplate = '<table class="tab_item"  id="{0}" border="0" cellpadding="0" cellspacing="0"><tr>' + '<td class="tab_item1"></td>'
			...
			+ '</tr></table>';
	var tabContainerTemplate = '<div class="benma_ui_tab" id="{0}"></div>';///放在div中间<div class="tab_hr"></div>
	...
	if (op.position == "bottom") {
		...
		tabContainerTemplate = '<div class="benma_ui_tab benma_ui_tab_bottom" id="{0}"></div>';//放在div中间<div class="tab_hr tab_hr_bottom"></div>二次开发
	}
