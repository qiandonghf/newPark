package com.wiiy.cms.activator;
...
import com.wiiy.cms.system.DataDictInit;

public class CmsActivator extends AbstractActivator {
	...
	public void startBundle(BundleContext context) throws Exception {
		...
		logger.debug("bundle 【parkmanager.cms.war】 start");
		//initProcess();
	}
	...
	protected void registryFK(){
		...
		if (fkServiceRef != null) {
			...
			fkService.registryFK(getFKDescription(bundleContext,"WEB-INF/classes/com/wiiy/cms/entity/"));
		} else {
	...
	public void stopBundle(BundleContext context) throws Exception {
		logger.debug("bundle 【parkmanager.cms.war】 stop");
	}
	...
	public static User getSessionUser(){
		...
		try {
			...
			System.out.println("CmsActivator.getSessionUser():"+e.getMessage());
		}
