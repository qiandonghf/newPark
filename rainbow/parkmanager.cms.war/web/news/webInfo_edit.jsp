...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
		...
		<td class="layerright"><input id="name" name="webInfo.name" type="text" class="inputauto" value="${result.value.name}"/></td>
    </tr>
    <tr>
    	<td class="layertdleft"><span class="psred">*</span>url地址：</td>
    	<td class="layerright">
    		<input name="webInfo.url" class="inputauto" type="text" value="${result.value.url}"/>
    	</td>
    </tr>
    <tr>
    	<td class="layertdleft">网址参数：</td>
    	<td class="layerright">
    		<input name="webInfo.params" value="${result.value.params}"  style="width:50%; padding-left:2px; height:20px; line-height:20px; border:1px solid #e0e0e0;" type="text"/>(例:id:1,type:post)
    	</td>
    </tr>
    <tr>
    	<td class="layertdleft"><span class="psred">*</span>内容匹配 &nbsp;<br/>正 则：</td>
    	<td class="layerright">
    		<textarea id="memo" name="webInfo.itemRegex" class="textareaauto" style="height:40px;">${result.value.itemRegex}</textarea>
    	</td>
    </tr>
    <tr>
    	<td class="layertdleft"><span class="psred">*</span>区域开始&nbsp;<br/>正则：</td>
    	<td class="layerright">
    		<textarea id="memo" name="webInfo.beginFlag" class="textareaauto" style="height:40px;">${result.value.beginFlag}</textarea>
    	</td>
    </tr>
        <tr>
    <td class="layertdleft"><span class="psred">*</span>区域结束&nbsp;<br/>正则：</td>
    	<td class="layerright">
    		<textarea id="memo" name="webInfo.endFlag" class="textareaauto" style="height:40px;">${result.value.endFlag}</textarea>
    	</td>
    </tr>
    <tr>
    	<td class="layertdleft">标示Id&nbsp;<br/>正则：</td>
    	<td class="layerright">
    		<textarea id="memo" name="webInfo.idRegex" class="textareaauto" style="height:30px;">${result.value.idRegex}</textarea>
    	</td>
    </tr>
    <tr>
    	<td class="layertdleft">日期正则：</td>
    	<td class="layerright">
    		<input name="webInfo.dateRegex" class="inputauto" type="text" value="${result.value.dateRegex}"/>
    	</td>
    </tr>
    <tr>
    	<td class="layertdleft">日期格式：</td>
    	<td class="layerright">
    		<input id="homePage" name="webInfo.datePattern"  value="${result.value.datePattern}" type="text" style="width:50%; padding-left:2px; height:20px; line-height:20px; border:1px solid #e0e0e0;" />
    	</td>
    </tr>
    <tr>
    	<td class="layertdleft">抓取间隔：</td>
    	<td class="layerright">
    		<input id="email" name="webInfo.period" value="${result.value.period}"  type="text" style="width:10%; padding-left:2px; height:20px; line-height:20px; border:1px solid #e0e0e0;" />小时
    	</td>
    </tr>
	</table>
</div>
