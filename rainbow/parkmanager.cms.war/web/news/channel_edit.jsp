...
<body>
<form action="<%=basePath%>column!updateSava.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
    <!--divlay-->
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
		...
		<td class="layerright"><input id="name" name="column.name" type="text" class="inputauto" value="${column.name }" /><input name="id" type="hidden" value="${id }" /></td>
    </tr>   
	</table>
</div>
<!--//divlay-->
