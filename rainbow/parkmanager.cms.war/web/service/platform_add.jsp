...
<body>
<form action="<%=basePath %>platform!save.action" method="post" name="form1" id="form1">
...
<input type="hidden" id="photo" name="platform.photo" value=""/>
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
       ...
       <td class="layerright"><input name="platform.name" type="text" class="inputauto" /></td>
       <td class="layertdleft100"><span class="psred">*</span>平台标题：</td>
       <td class="layerright"><input name="platform.title" type="text" class="inputauto" /></td>
    </tr>
    <tr>
       <td class="layertdleft100"><span class="psred"></span>平台URL：</td>
       <td class="layerright"><input name="platform.url" type="text" class="inputauto" /></td>
	   <td class="layertdleft100">自定义属性：</td>
       <td class="layerright">
          <input type="checkbox" name="platform.toped" value="<%=BooleanEnum.YES%>" /> 置顶
          <input type="checkbox" name="platform.recommend" value="<%=BooleanEnum.YES%>" /> 首页推荐
		  <input type="checkbox" name="platform.bold" value="<%=BooleanEnum.YES%>" /> 加粗
	   </td>
    </tr>
    <tr>
       <td class="layertdleft100"><span class="psred"></span>地址：</td>
       <td class="layerright"><input name="platform.address" type="text" class="inputauto" /></td>
	   <td class="layertdleft100">电话：</td>
       <td class="layerright"><input name="platform.phone" type="text" class="inputauto" /></td>
    </tr>
    <tr>
	      ...
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          <td width="230" id="catTd"><label>
	            <input readonly="readonly" id="typeName" name="type.typeName" type="text" class="inputauto" onclick="selectCatlog()"/>
	            <input id="typeId" type="hidden" name="type.id" />
	          </label></td>
    ...
    <tr>
       ...
       <td class="layerright" colspan="3" style="padding-top:1px;">
     		<textarea id=content name="platform.content" style="height:200px;margin-top:2px;" class="textareaauto"></textarea>
			<script type="text/javascript">
