...
<body>
<form action="<%=basePath %>federation!save.action" method="post" name="form1" id="form1">
...
<input type="hidden" id="photo" name="federation.photo" value=""/>
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
       ...
       <td class="layerright"><input name="federation.name" type="text" class="inputauto" /></td>
       <td class="layertdleft100">联盟标题：</td>
       <td class="layerright"><input name="federation.title" type="text" class="inputauto" /></td>
    </tr>
    <tr>
       <td class="layertdleft100"><span class="psred"></span>网址域名：</td>
       <td class="layerright"><input name="federation.website" type="text" class="inputauto" /></td>
	   <td class="layertdleft100">自定义属性：</td>
       <td class="layerright">
          <input type="checkbox" name="federation.toped" value="<%=BooleanEnum.YES%>" /> 置顶
          <input type="checkbox" name="federation.recommend" value="<%=BooleanEnum.YES%>" /> 首页推荐
		  <input type="checkbox" name="federation.bold" value="<%=BooleanEnum.YES%>" /> 加粗
	   </td>
    </tr>
    <tr>
	   <td class="layertdleft100">联系电话：</td>
       <td class="layerright"><input name="federation.phone" type="text" class="inputauto" /></td>
       <td class="layertdleft100"><span class="psred"></span>Email：</td>
       <td class="layerright"><input name="federation.email" type="text" class="inputauto" /></td>
    </tr>
    <tr>
    ...
    <tr>
       ...
       <td class="layerright" colspan="3" style="padding-top:1px;">
     		<textarea id=content name="federation.content" style="height:200px;margin-top:2px;" class="textareaauto"></textarea>
			<script type="text/javascript">
