...
$(document).ready(function(){
 ...
 function initForm(){
	$("#form1").validate({
		...
		messages: {
			"floatingWindow.name":"请填写浮窗名称",
			"floatingWindow.type":"请选择浮窗类型"
		},
			...
			$(form).ajaxSubmit({
		        ...
		        success: function(data){
		        	...
		        	if(data.result.success){
		        		setTimeout("getOpener().reloadInitList();parent.fb.end();", 2000);
		        	}
		        } 
		    });
		}
...
<body>
<form action="<%=basePath %>floatingWindow!save.action" method="post" name="form1" id="form1">
<input id="path" type="hidden" name="floatingWindow.resourcePath" />
<input type="hidden" name="floatingWindow.paramId" value="${id }"/>
<input id="newName" type="hidden" name="floatingWindow.newName"/>
<input id="oldName" type="hidden" name="floatingWindow.oldName"/>
<!--basediv-->
<div class="basediv">
<!--divlay-->
<div class="divlays" style="margin:0px;float:left;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
	      ...
	      <td class="layerright">
	         <input type="radio" name="floatingWindow.enable" value="<%=BooleanEnum.YES%>" checked="checked"/>&nbsp;启用
	     	 <input type="radio" name="floatingWindow.enable" value="<%=BooleanEnum.NO%>"/>&nbsp;禁用
		  </td>
	</tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>浮窗名称：</td>
      <td><input name="floatingWindow.name" type="text" class="input200"  /></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>浮窗类型：</td>
      <td class="layerright">
      	<enum:select id="type" type="com.wiiy.cms.preferences.enums.FloatingTypeEnum" name="floatingWindow.type"/>
	  </td>
    </tr>
    <tr>
      <td class="layertdleft100">浮窗内容：</td>
      <td style="padding-top:2px;padding-bottom:2px;">
      	<textarea class="input200" name="floatingWindow.content" style="height:40px;resize:none;"></textarea>
	  </td>
    </tr>
    <tr>
       <td class="layertdleft100">浮窗链接：</td>
       <td><input name="floatingWindow.url" type="text" class="input200"  /></td>
    </tr>
    <tr>
      ...
      <td class="layerright">
      	<table>
      		<tr>
      			<td>宽:</td>
      			<td><input name="floatingWindow.width" type="text" class="input60" onkeyup="value=value.replace(/[^\d]/g,'')" /></td>
      			<td><span style="margin-left:5px;">高:</span></td>
      			<td><input name="floatingWindow.height" type="text" class="input60" onkeyup="value=value.replace(/[^\d]/g,'')" /></td>
      		</tr>
      	</table>
      </td>
    </tr>
		...
		<tr>
	        <td class="layerright">
	        	<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
		            ...
		            <tr class="pic">
			           <td width="96">
			           	<img id="imgPath" src="core/common/images/carbg.jpg" width="107" height="110" class="touxian"  style="margin-left:0px;"/>
			           </td>
