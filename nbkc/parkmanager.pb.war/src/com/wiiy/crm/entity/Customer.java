...
public class Customer extends BaseEntity implements Serializable {
	 ...
	 * 企业分类
	 */
	@FieldDescription("企业分类")
	private DataDict customerType;
	/**
	 * 企业分类Id
	 */
	@FieldDescription("企业分类id")
	 ...
	 * 消息传递标识
	 */
	@FieldDescription("消息传递标识")
	private EntityStatus messageSend;
	/**
	 * 企业性质
	 */
	@FieldDescription("企业性质")
	 ...
	 * 消息传递标识
	 */
	public EntityStatus getMessageSend(){
		return messageSend;
	}
	public void setMessageSend(EntityStatus messageSend){
	...
	public DataDict getCustomerType() {
		return customerType;
	}
	public void setCustomerType(DataDict customerType) {
