...
<input type="hidden" name="meter.type" value="ELECTRICITY"/>
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="layertdleft100"><span class="redweight">*</span>电表名称：</td>
      <td><input name="meter.name" type="text" class="input170" /></td>
      <td class="layertdleft100"><span class="redweight">*</span>电表倍数：</td>
      <td><input name="meter.meterFactor" type="text" class="input170" /></td>
      </tr>
    <tr>
      <td class="layertdleft100"><span class="redweight">*</span>电表编号：</td>
      <td><input name="meter.orderNo" type="text" class="input170" /></td>
      <td class="layertdleft100">母表编号：</td>
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td><input readonly="readonly" id="parentNo" name="meter.parentNo" type="text" class="inputauto" onclick="fbStart('选择母表编号','<%=basePath%>web/property/meter_select2.jsp',520,420);"/></td>
            <td width="25" align="center"><img src="core/common/images/outdiv.gif" width="20" height="22" onclick="fbStart('选择母表编号','<%=basePath%>web/property/meter_select2.jsp',520,420);"/></td>
          </tr>
        </tbody>
      </table></td>
    </tr>
    <tr>
		<td class="layertdleft100">装机容量：</td>
     	<td><input name="meter.capacity" type="text" class="input170" /></td>
		<td class="layertdleft100">基本电费：</td>
     	<td><input name="meter.capacityBill" type="text" class="input170" /></td>
    </tr>
    <tr>
      <td class="layertdleft100">电表序列号：</td>
    ...
    <tr>
      ...
      <td class="layertdleft100"><span class="redweight">*</span>电表性质：</td>
      <td class="layerright">
      	 <enum:select type="com.wiiy.pb.preferences.enums.MeterKindEnum" name="meter.kind" />
      </td>
    </tr>
    <tr>
      ...
      <td class="layertdleft100"><span class="redweight">*</span>电表状态：</td>
      <td class="layerright">
     	 <enum:select type="com.wiiy.pb.preferences.enums.MeterStatusEnum" name="meter.status" />
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" class="layerright"><textarea name="meter.memo" rows="3" class="textareaauto"></textarea></td>
      </tr>
  </table>
</div>
<!--//divlay-->
