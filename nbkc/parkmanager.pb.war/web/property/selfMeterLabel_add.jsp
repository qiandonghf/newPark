...
<body>
<form action="<%=basePath%>selfMeterLabel!save.action" method="post"  name="form1" id="form1">
<!--basediv-->
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class=""  colspan="3">
      		<input name="selfMeterLabel.name" type="text" class="input170" style="width:94%;"/>
      </td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="redweight">*</span>报表类型：</td>
      <td class="layerright">	
      	 <enum:select type="com.wiiy.pb.preferences.enums.MeterTypeEnum" name="selfMeterLabel.type"/>
      </td>
    </tr>
    <tr>
       ...
       <td class="layerright">
        	<table width="35%" border="0" cellspacing="0" cellpadding="0">
	           <tr>
	              <td><input readonly="readonly" id="date" name="selfMeterLabel.date" type="text" class="inputauto"  value="<%=DateUtil.format(new Date())%>"  onclick="return showCalendar('date');"/></td>
    ...
    <tr>
      ...
      <td class="layerright"  colspan="3">
      	   ...
      	   <input type="hidden" name="selfMeterLabel.reader" value="<%=PbActivator.getSessionUser(request).getRealName()%>"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="layerright" colspan="3"><textarea name="selfMeterLabel.memo" rows="3" class="textareaauto"></textarea></td>
      </tr>
  </table>
</div>
<!--//divlay-->
