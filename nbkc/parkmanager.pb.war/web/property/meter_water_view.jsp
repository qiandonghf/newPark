...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="layertdleft100" style="white-space:nowrap;">水表序列号：</td>
    ...
    <tr>
      ...
      <td class="layertdleft100">水表性质：</td>
    ...
    <tr>
      ...
      <td class="layertdleft100">水表状态：</td>
      <td class="layerright" style="width:170px;">
     	${meter.status.title}
      </td>
    </tr>
