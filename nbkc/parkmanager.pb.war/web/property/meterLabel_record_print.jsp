...
<div class="tablediv">
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="table">
      <tr>
        ...
        <td width="100" rowspan="2" >单位名称</td>
        <td width="100" rowspan="2" >单元号</td>
        <td width="130" rowspan="2" >客户名称</td>
      ...
      <c:forEach items="${meterLabelRecordList}" var="list" varStatus="status">
	      <tr>
	...
	<div class="tablefooter"><span></span>制表人：<%=PbActivator.getSessionUser(request).getRealName() %></div>
