...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><input name="parkingManage.parkingId" type="text" class="input170" /></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="redweight">*</span>状态：</td>
      <td class="layerright"><label><enum:select type="com.wiiy.pb.preferences.enums.ParkingManageEnum" name="parkingManage.status" /></label></td>
    </tr>
   
    <tr>
      <td class="layertdleft100">描述：</td>
      <td class="layerright"><label>
        <textarea name="parkingManage.description" rows="4" class="textareaauto"></textarea>
      </label></td>
    </tr>
  </table>
</div>
