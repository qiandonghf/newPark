		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="layerright">
						<enum:select id="name" name="deviceManagement.status" checked="result.value.status" type="com.wiiy.pb.preferences.enums.DeviceStatusEnum"/>
					</td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="" style="position: relative;left:5px;height:22px;border-color: #333;">
									<enum:select id="patrolIntervalType" name="deviceManagement.patrolIntervalType" checked="result.value.patrolIntervalType"  type="com.wiiy.pb.preferences.enums.PatrolIntervalEnum"/>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td colspan="5" class="layerright">
						<textarea name="deviceManagement.remarks" class="inputauto" style="height:40px;resize: none;">${result.value.remarks}</textarea>
					</td>
				</tr>
			</table>
		</div>
						...
						<ul>
							<li onmouseover="this.className='libg'" 
								...
								onclick="fbStart('新增设备巡检',
									'<%=basePath %>web/property/devicePatrol_add.jsp?deviceId=${result.value.id }',600,327);">
								<span><img src="core/common/images/emailadd.gif" /></span>添加
							</li>
							<li onmouseover="this.className='libg'" 
								onmouseout="this.className=''" 
						...
						<ul>
							<li onmouseover="this.className='libg'" 
								...
								onclick="fbStart('新增设备年检',
									'<%=basePath %>web/property/deviceYearly_add.jsp?deviceId=${result.value.id }',600,327);">
								<span><img src="core/common/images/emailadd.gif" /></span>添加
							</li>
							<li onmouseover="this.className='libg'" 
								onmouseout="this.className=''" 
						...
						<ul>
							<li onmouseover="this.className='libg'" 
								...
								onclick="fbStart('新增维修派工单',
									'<%=basePath %>web/property/deviceWorkOrder_add.jsp?deviceId=${result.value.id }',600,327);">
								<span><img src="core/common/images/emailadd.gif" /></span>添加
							</li>
							<li onmouseover="this.className='libg'" 
								onmouseout="this.className=''" 
