	...
	function initList(){
		...
		$("#list").jqGrid({
			...
			colModel: [
				...
				{label:'本期读数',width:70, name:'curReading',align:"center",editable:true, edittype:'custom', editoptions:{custom_element: myelem, custom_value:myvalue},formatter: curR,classes:'pointSpan'},
			    ...
			    {label:'实用量', width:70,name:'syAmount',align:"center"}, 
			    {label:'损益%',width:60, name:'', align:"center"},
			    {label:'合计',width:100, name:'totalAmount', align:"center"},
				...
				<div class="apptab" id="tableid">
					<ul>
						...
						<c:if test="${result.value.checkOut eq 'GENERATED'}">
							<li class="apptabli" onclick="showIfream();">收费报表</li>
						</c:if>
					</ul>
				</div>
