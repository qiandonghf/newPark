...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class=""><input name="complaint.name" type="text" class="input170" /></td>
      <td class="layertdleft100">联系电话：</td>
      <td class=""><input name="complaint.tel" type="text" class="input170" /></td>
    </tr>
    <tr>
      ...
      <td colspan="5" class="layerright">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          <td width="155"><label>
	            <input id="customerName" type="text" class="inputauto" />
	            <input id="customerId" name="complaint.customerId" type="hidden"/>
	          </label></td>
    ...
    <tr>
      ...
      <td colspan="5" class="layerright">
      	<enum:radio name="complaint.importance" type="com.wiiy.pb.preferences.enums.ImportanceEnum" />
      </td>
      </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>投诉对象：</td>
      <td colspan="5"><input name="complaint.complaintObject" type="text" class="input170" /></td>
    </tr>
  
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>投诉内容：</td>
      <td colspan="5" class="layerright"><label>
        <textarea name="complaint.content" rows="4" class="textareaauto"></textarea>
      </label></td>
    </tr>
  </table>
</div>
