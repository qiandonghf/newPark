...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath %>investmentProcessAtt!update.action" method="post" name="form1" id="form1">
			<input type="hidden" value="${result.value.id}" name="investmentProcessAtt.id"/>
			<div class="basediv">
				<div class="divlays" style="margin:0px;">
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="layertdleft100">名称：</td>
							<td class="layerright"><input id="name" name="investmentProcessAtt.name" type="text" class="inputauto" value="<format:fileName value="result.value.name"/>"/></td>
						</tr>
					</table>
				</div>
