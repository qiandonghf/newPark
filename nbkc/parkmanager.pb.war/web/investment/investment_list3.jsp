...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function initMenu(){
				var menu = 
				<%if(PbActivator.getHttpSessionService().isInResourceMap("pb_project_allView") || PbActivator.getHttpSessionService().isInResourceMap("pb_project_allEdit") || PbActivator.getHttpSessionService().isInResourceMap("pb_project_allPrint") || PbActivator.getHttpSessionService().isInResourceMap("pb_approval_all")){%>
					[[
				<%
				...
				<%}%>],[
				  <%-- <%if(PbActivator.getHttpSessionService().isInResourceMap("pb_approval_all")) {%>      
			...
			function jumpPage(page){
				var url = "<%=basePath%>investment!list3.action";
				url += "?page="+page;
				if($("#name").val()){
					url += "&name="+$("#name").val();
				}
