...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath %>investmentLog!mySave.action" method="post" name="form1" id="form1">
			<input type="hidden" value="${result.value.id}" name="investmentLog.investmentId"/>
			<div class="basediv">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="layerright">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="200"><input id="username" value="<%=PbActivator.getSessionUser(request).getRealName() %>" name="investmentLog.userName" readonly="readonly" type="text" class="inputauto" /><input id="userId" name="investmentLog.userId" value="<%=PbActivator.getSessionUser(request).getId() %>" type="hidden" class="inputauto" /></td>
									<td width="25" align="center"><img style="cursor:pointer;" onclick="fbStart('选择联系人','<%=BaseAction.rootLocation %>/core/user!select.action',520,400);" src="core/common/images/outdiv.gif" width="20" height="22" /></td>
									<td align="center">&nbsp;</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						...
						<td class="layerright">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="200"><input id="linkTime" name="investmentLog.linkTime" type="text" readonly="readonly" class="inputauto" onclick="showCalendar('linkTime')"/></td>
									<td width="25" align="center"><img style="cursor:pointer;" src="core/common/images/timeico.gif" width="20" height="22" onclick="showCalendar('linkTime')"/></td>
									<td align="center">&nbsp;</td>
								</tr>
							</table>
						</td>
