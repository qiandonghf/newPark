  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="390">
	          <input id="name" name="investmentProcess.name" value="${investment.name }" class="inputauto" type="text" readonly="readonly"/>
          </td>         
        </tr>
      </table></td>
      </tr>
    <tr>
     ...
     <tr>
      ...
      <td class="layerright">     	
      	<input id="projectMemo" name="investmentProcess.projectMemo" value="${investment.projectMemo }" type="text" class="inputauto"/>
      	<input id="investmentId" name="investmentProcess.investmentId" value="${investment.id }" type="hidden" />
      </td>
    </tr>
    <tr>
