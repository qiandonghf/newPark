...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath %>policy!save.action" method="post" name="form1" id="form1">
			<div class="basediv">
			<div class="divlays" style="margin:0px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="layerright"><dd:select id="typeId" name="policy.typeId" key="crm.0022"/></td>
					</tr>
					<tr>
						<td class="layertdleft100"><span class="psred">*</span>启用：</td>
						<td class="layerright"><enum:radio name="policy.usable" type="com.wiiy.commons.preferences.enums.BooleanEnum"/></td>
					</tr>
					<tr>
						<td class="layertdleft100"><span class="psred">*</span>内容：</td>
						<td class="layerright"><textarea name="policy.content" style="height:100px;" class="textareaauto"></textarea></td>
					</tr>
					<tr>
						<td class="layertdleft100">备注：</td>
						<td class="layerright"><textarea name="policy.memo" style="height:100px;" class="textareaauto"></textarea></td>
					</tr>
				</table>
			</div>
