	...
	<head>
		...
		<script type="text/javascript">
			...
			function initMenu(){
				...
				var menu3 = 
					<%if(PbActivator.getHttpSessionService().isInResourceMap("pb_project_allView")||PbActivator.getHttpSessionService().isInResourceMap("pb_project_allEdit")||PbActivator.getHttpSessionService().isInResourceMap("pb_project_allPrint")||PbActivator.getHttpSessionService().isInResourceMap("pb_project_allSubmission")){%>
					[[
				<%
				boolean flag3 = false;
				if(PbActivator.getHttpSessionService().isInResourceMap("pb_project_allView")){
						...
						<div class="write_list" style="border-right:1px solid #ddd; width:355px;" id="resizable">
							...
							<div id="contentDiv" style="height:300px;overflow-y:auto;" >
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="lsittable">
									...
									<tr onmouseout="this.style.background='#fff';keepHighlight(this)" onmouseover="this.style.background='#f4f4f4';"  class="investmenttr${investment.investmentStatus }" style="cursor: pointer;" onclick="openRight(${investment.id});highlight(this);">
										...
										<td class="lefttd" style="width:220px;" align="center">${investment.name}<input type="hidden" value="${investment.id}" /><input type="hidden" value="${investment.regInfo.organizationNumber}" /></td>
