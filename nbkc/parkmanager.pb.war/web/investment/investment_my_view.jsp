			...
			<div class="emailtop">
				<div class="leftemail">
					...
					<%if(PbActivator.getHttpSessionService().isInResourceMap("pb_project_myEdit")){ %>
						<li onmouseover="this.className='libg'" onmouseout="this.className=''"  onclick="fbStart('编辑申请单','<%=basePath%>investment!myEdit.action?id=${result.value.id}',700,538);"><span><img src="core/common/images/edit.gif" /></span>编辑</li>
					<%}%>
