		...
		<div  class="pm_msglist" id="investRight_height3" style="overflow-y:auto;overflow-x:hidden;">
			<div>
				<div class="emailtop">
					<div class="leftemail">
						<ul>
						<%if(PbActivator.getHttpSessionService().isInResourceMap("pb_businessPlan_allEdit")){ %>
						...
						<%} %>	
						<%if(PbActivator.getHttpSessionService().isInResourceMap("pb_businessPlan_allUp")){ %>
