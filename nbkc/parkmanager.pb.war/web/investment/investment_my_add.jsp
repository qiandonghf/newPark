	...
	<head>
		...
		<script type="text/javascript">
			...
			function viewById(id){
				fbStart('投资人信息','<%=basePath %>investmentInvestor!myView.action?id='+id,450,251);
			}
			function editDirectorById(id){
				fbStart('负责人信息','<%=basePath %>investmentDirector!myEdit.action?id='+id,450,251);
			}
			function editInvestorById(id){
				fbStart('投资人信息','<%=basePath %>investmentInvestor!myEdit.action?id='+id,450,251);
			}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="layerright" >
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="35"><input id="hostId" name="investment.hostId" type="hidden" class="inputauto" value="<%=PbActivator.getSessionUser(request).getId() %>" /><input id="hostName" name="investment.hostName" readonly="readonly" type="text" class="inputauto" onclick="selectUser(1)" value="<%=PbActivator.getSessionUser(request).getRealName() %>"/></td>
							...
							<td class="layerright" >
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="35"><input id="importId" name="investment.importId" type="hidden" class="inputauto" value="<%=PbActivator.getSessionUser(request).getId() %>" /><input id="importName" name="investment.importName" readonly="readonly" type="text" class="inputauto" onclick="selectUser(2)" value="<%=PbActivator.getSessionUser(request).getRealName() %>"/></td>
			...
			<div style="height:205px;">
				...
				<div class="basediv tabswitch" style="margin-top:0px; display:block;" name="textname" id="textname">
					<div class="emailtop">
						<div id="director" class="leftemail" style="display: none;">
							<ul>
								<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('负责人信息','<%=basePath %>web/investment/investmentDirector_my_add.jsp?investmentId='+$('#investmentId').val(),400,206);"><span><img src="core/common/images/emailadd.gif" /></span>添加</li>
				...
				<div class="basediv tabswitch" style="margin-top:0px; display:none;" name="textname" id="textname">
					<div class="emailtop">
						<div class="leftemail">
							<ul>
								<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('投资人信息','<%=basePath %>web/investment/investmentInvestor_my_add.jsp?investmentId='+$('#investmentId').val(),450,251);"><span><img src="core/common/images/emailadd.gif" /></span>添加</li>
