...
<body>
<form action="<%=basePath %>financeContact!save.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
				...
				<div class="divlays" style="margin:0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="layertdleft120"><div style="width: 140px"><span class="psred">*</span>租赁客户名称：</div></td>
							<td class="layerright"><table width="60%" border="0" cellspacing="0" cellpadding="0">
       						 <tbody><tr>
							          ...
							          <input id="customerId" name="financeContact.customerId" type="hidden" /><input id="customer" name="financeContact.customer" class="inputauto" onclick="selectCustomer()" readonly="readonly"/></td>
						...
						<tr>
							...
							<td class="layerright">
								<table width="60%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
										<input type="hidden" name="financeContact.roomId" id="roomId"  />
										<input id="room" type="text" class="inputauto" onclick="selectRoom()" readonly="readonly"/></td>
						...
						<tr>
							...
							<td colspan="3" class="layerright" style="padding-top:2px;"> <textarea name="financeContact.content"  class="textareaauto"  rows="4"></textarea></td>
						</tr>
					</table>
				</div>
