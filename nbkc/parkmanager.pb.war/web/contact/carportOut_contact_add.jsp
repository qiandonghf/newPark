					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="layerright" >
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width=""><input id="responsibleId" name="carportOutContact.responsibleId" type="hidden" class="inputauto" /><input id="responsible" name="carportOutContact.responsible" readonly="readonly" type="text" class="inputauto" onclick="selectUser()" /></td>
