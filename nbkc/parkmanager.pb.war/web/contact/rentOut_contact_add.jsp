...
<body>
<form action="<%=basePath %>rentOutContact!save.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<table width="60%" border="0" cellspacing="0" cellpadding="0">
	       						 <tbody><tr>
								          <td><input name="rentOutContact.type" value="<%=ContactTypeEnum.RENTOUTCONTACT %>" type="hidden"/>
								          <input id="customerId" name="rentOutContact.customerId" type="hidden" /><input id="customer" name="rentOutContact.customer" class="inputauto" onclick="selectCustomer()" readonly="readonly"/></td>
						...
						<tr>
							<td class="layertdleft120"><span class="psred">*</span>原租赁房屋房号/面积：</td>
							<td class="layerright">
								<table width="60%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
											<input type="hidden" name="rentOutContact.roomId" id="roomId"  />
											<input id="room" type="text" class="inputauto" onclick="selectRoom()" readonly="readonly"/>
										</td>
						...
						<tr>
							...
							<td colspan="3" class="layerright" style="padding-top:2px;"> <textarea name="rentOutContact.reason"  class="textareaauto"  rows="4"></textarea></td>
						</tr>
						<tr>
							<td class="layertdleft120">备注：</td>
							<td colspan="3" class="layerright" style="padding-top:2px;"> <textarea name="rentOutContact.description"  class="textareaauto"  rows="4"></textarea></td>
						</tr>
					</table>
				</div>
