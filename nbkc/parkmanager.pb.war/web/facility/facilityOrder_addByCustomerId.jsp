...
<form action="<%=basePath %>facilityOrder!save.action" method="post" name="form1" id="form1">
	<input type="hidden" value="${facilityId}" name="facilityOrder.typeId"/>
	<div class="basediv">
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="layertdleft100">企业名称：</td>
						<td class="layerright"><input id="customerId" name="facilityOrder.customerId" type="hidden" value="${customerId}" /><input id="customerName" type="hidden" name="customerName" type="text" value="${customerName}"/>${customerName}
					</td>
				</tr>
				<tr>
				...
				<tr>
			      ...
			      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			        <tr>
			          <td width="25"><label>
			            <select name="facilityOrder.contractId">
				            <option>------请选择------</option>
