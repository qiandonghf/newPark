...
<script type="text/javascript">
	...
	function initList(){
		...
		$("#list").jqGrid({
			...
			colModel: [
				...
				{label:'企业名称', name:'contract.customerName', align:"center",width:250}, 
				{label:'费用类型', name:'type.title', align:"center",width:80}, 
				{label:'金额', name:'amount',formatter:'number',width:80,formatoptions:{decimalSeparator:".", thousandsSeparator: " ", decimalPlaces: 2, defaulValue: 0}, align:"center"}, 
			    {label:'管理', name:'manager', align:"center", width:80 ,resizable:false,sortable:false}
			],
			height: height,
			width: width,
			shrinkToFit: false,
	...
	function viewById(id){
		fbStart('查看',"<%=basePath%>deposit!view.action?id="+id,500,222);
	}
	...
	function initList2(){
		...
		$("#list2").jqGrid({
			colModel: [
				...
				{label:'企业名称', name:'contract.customerName', align:"center",width:250}, 
				{label:'费用类型', name:'type.title', align:"center",width:80}, 
				{label:'出账类型', name:'checkout', align:"center",width:80}, 
				{label:'金额', name:'amount',formatter:'number',align:"center",width:60}, 
	...
	function checkout(){
		...
		var url = "<%=basePath%>deposit!batchCheckout.action";
										...
										<tr>
											...
											<td width="90">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td>
															<search:choose dataType="java.util.Date" field="contract.startDate" op="le">
											...
											<td width="90" style="padding-left: 3px;padding-right: 3px;">
												<search:choose dataType="com.wiiy.crm.preferences.enums.RentBillPlanFeeEnum" field="feeType" op="eq">
												<enum:select type="com.wiiy.crm.preferences.enums.RentBillPlanFeeEnum" styleClass="data"/>
												</search:choose>
											</td>
											<td width="90"><label><img src="core/common/images/search.gif" width="75" height="22" border="0" onclick="doSearch()"></label></td>
										</tr>
									</tbody>
								</table>
							</form>
