...
<script type="text/javascript">
	function initSubjectList(){
		$("#subjectNetworkList").jqGrid({
			...
			colModel: [
			    ...
			    {label:'管理', name:'manager', align:"center",hidden:true,width:35, resizable:false,sortable:false}
			],
			height: 172,
			width: 740,
			rowNum: 0,
	...
	function initBillPlanList(){
		$("#billPlanFacilityList").jqGrid({
			...
			colModel: [
			    ...
			    {label:'管理', name:'manager', align:"center",hidden:true, resizable:false,width:70,sortable:false}
			],
			height: 172,
			width: 740,
			rowNum: 0,
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					content += "<img src=\"core/common/images/rece2.gif\" width=\"14\" height=\"14\" title=\"出账\" onclick=\"billPlanFacilityCheckinById('"+id+"');\"  /> "; 
					content += "<img src=\"core/common/images/pay2.gif\" width=\"14\" height=\"14\" title=\"出账\" onclick=\"billPlanFacilityCheckoutById('"+id+"');\"  /> "; 
					$(this).jqGrid('setRowData',id,{manager:content});
				}
			}
		});
	...
	<div class="basediv tabswitch" style="margin-top:0px; display:block" id="textname" name="textname">
		<div class="emailtop" style="display: none;">
			<div class="leftemail">
				<ul>
