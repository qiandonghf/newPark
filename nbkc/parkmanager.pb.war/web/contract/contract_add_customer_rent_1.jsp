	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
		<tr>
			<td class="layertdleft100"><span class="psred">*</span>合同编号：</td>
      		...
      		<td class="layerright" width="25%"><input name="contract.propertyName" type="text" class="inputauto" style="width:99%;" value="三略科技" /></td>
    	</tr>
    	<tr>
	      	...
	      	<td class="layerright" width="33%"><input name="contract.address" type="text" class="inputauto" style="width:99%;" value="宁波市江南路1558号" /></td>
      	</tr>
      	<tr>
