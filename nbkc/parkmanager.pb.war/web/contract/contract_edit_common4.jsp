		...
		function initForm(){
			$("#form1").validate({
				...
				messages: {
					...
					"contract.customerName":"请选择企业",
					"contract.managerId":"请选择负责人"
				},
		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td colspan="3" class="layerright"><input name="contract.name" value="${result.value.name}" type="text" class="inputauto" /></td>
				</tr>
				<tr>
					...
					<td class="layerright" width="270">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><input id="contractNo" name="contract.contractNo" value="${result.value.contractNo}" type="text" class="inputauto" /></td>
				...
				<tr>
					...
					<td class="layerright">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="110"><input id="startDate" readonly="readonly" name="contract.startDate" type="text" value="<fmt:formatDate value="${result.value.startDate}" pattern="yyyy-MM-dd"/>" class="inputauto" onclick="showCalendar('startDate')"/></td>
					...
					<td class="layertdleft100"><span class="psred">*</span>交付日期：</td>
					<td class="layerright">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><input id="finishDate" readonly="readonly" name="contract.receiveDate" type="text" class="inputauto" value="<fmt:formatDate value="${result.value.receiveDate}" pattern="yyyy-MM-dd"/>" onclick="showCalendar('finishDate')"/></td>
				...
				<tr>
					...
					<td class="layertdleft100">租凭用途：</td>
					<td class="layerright"><input name="contract.purpose" type="text" class="inputauto" value="${result.value.purpose}"/></td>
				</tr>
			</table>
		</div>
