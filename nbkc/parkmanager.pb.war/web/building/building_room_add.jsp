...
<script type="text/javascript">
	...
	function initForm(){
		$("#form1").validate({
			rules: {
				"room.building.parkId":"required",
				"room.buildingId":"required",
			...
			messages: {
				"room.building.parkId":"请选择所在园区",
				"room.buildingId":"请选择所在楼宇",
...
<div class="divlays">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><select id="park" name="room.building.parkId" onchange="selectBuilding();">
    ...
    <tr>
      ...
      <td class="layerright"><select id="building" name="room.buildingId" onchange="selectFloor();">
    ...
    <tr>
      <td class="layertdleft100">租金区间：</td>
        ...
        <tr>
          ...
          <td width="32" align="center">(元)</td>
        </tr>
      </table>      <label></label></td>
      <td class="layertdleft100">显示权值：</td>
      <td class="layerright"><input id="displayOrder" name="room.displayOrder" type="text" class="input100" /></td>
    </tr>
    <tr>
      ...
      <tr>
      	<td>
      		<input id="buildingArea" name="room.buildingArea" type="text" class="inputauto" onkeyup="value=value.replace(/[^\d\.]/g,'')"/>
      	</td>
      ...
      <tr>
      	<td>
     		<input id="realArea" name="room.realArea" type="text" class="inputauto" onkeyup="value=value.replace(/[^\d\.]/g,'')"/>
    	</td>
      <td width="30" align="center">(㎡)</td>
      </tr></table></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="3"><span class="layerright">
        <textarea id="discountRate" name="room.discountRate" rows="3" class="textareaauto"></textarea>
      </span></td>
    </tr>
     <tr>
