...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <tr><td><input id="maxArea" name="building.maxArea" type="text" value="<fmt:formatNumber value="${result.value.maxArea}" pattern="#0.00"/>" class="inputauto" onkeyup="value=value.replace(/[^\d\.]/g,'')"/> </td>
      <td width="30" align="center">(㎡)</td>
      </tr></table></td>
      </tr>
  </table>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright" style=" padding-bottom:2px;  padding-top:2px;"><label>
        <textarea name="building.summary" style="height:40px;" class="textareaauto" >${result.value.summary }</textarea>
      </label></td>
    </tr>
    <tr>
      <td class="layertdleft100">周边配套设施：</td>
      <td class="layerright"  style=" padding-bottom:2px;"><textarea name="building.supportSituation" style="height:40px;" class="textareaauto" >${result.value.supportSituation }</textarea></td>
    </tr>
    <tr>
      <td class="layertdleft100">交通情况：</td>
      <td class="layerright"><textarea name="building.trafficSituation" style="height:40px;" class="textareaauto"  >${result.value.trafficSituation }</textarea></td>
    </tr>
     <tr>
      <td class="layertdleft100">照片：</td>
      <input type="hidden" id="photos" name="building.photos" value="${result.value.photos }"/>
      <td class="layerright">
