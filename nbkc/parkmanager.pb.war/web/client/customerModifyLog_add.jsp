...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath %>customerModifyLog!save.action" method="post" name="form1" id="form1">
			<input type="hidden" value="${result.value.id}" name="customerModifyLog.customerId"/>
			<div class="basediv">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="layerright">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="200"><input id="linkTime" name="customerModifyLog.modifyLogTime" type="text" class="inputauto" onclick="return showCalendar('linkTime')"/></td>
					...
					<tr>
						...
						<td class="layerright"><textarea name="customerModifyLog.content" style="height:150px;" class="textareaauto"></textarea></td>
					</tr>
				</table>
			</div>
