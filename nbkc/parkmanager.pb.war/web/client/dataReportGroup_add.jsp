...
<body>
<form action="<%=basePath %>dataReportGroup!save.action" method="post" name="form1" id="form1">
<div class="basediv">
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="layertdleft100"><span class="psred">*</span>名称：</td>
				<td class="layerright"><input id="name" name="dataReportGroup.name" type="text" class="inputauto" onkeydown="keyHandle(event);"/></td>
			</tr>
		</table>
	</div>
