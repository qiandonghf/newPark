...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function openCustomerInfo(id){
				fbStart("基本信息变更",'<%=basePath %>customer!editCustomerBasicInfo.action?id='+id,870,450);
			}
			function initList(){		
				...
				$("#list").jqGrid({
					...
					colModel: [
						...
						{label:'企业id', name:'customerId', width:30,align:"center",hidden:true}, 
			...
			function updateCustomerInfo(id){
				if(confirm("基本信息需要修改吗？")){
					var tab = parent.$('#tt').tabs('getSelected');
			 		parent.window.frames[parent.$('#tt').tabs('getTabIndex',tab)].reloadList();
					parent.fb.end();
					fbStart("基本信息变更",'<%=basePath %>customer!editCustomerBasicInfo.action?id='+id,870,450);
				}
			}
