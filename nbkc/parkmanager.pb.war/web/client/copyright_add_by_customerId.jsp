				...
				$('#form1').ajaxSubmit({ 
			        ...
			        success: function(data){
			        	...
			        	if(data.result.success){
			        		setTimeout("getOpener().reloadList('copyright');parent.fb.end();", 2000);
			        	}
			        } 
			    });
			}
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
   	<tr>
	      ...
	      <td class="layerright">${result.value.name}<input id="customerId" name="copyright.customerId" type="hidden" value="${result.value.id}"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="layerright">
        <dd:select id="type" name="copyright.typeId" key="crm.0009"/>
      </td>
    </tr>
    <tr>
      ...
      <td class="layerright"><table width="205" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="20"><img src="core/common/images/timeico.gif" style="position: relative;left:-1px;" width="20" height="22" onclick="return showCalendar('effectivetime');"   /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <td class="layerright"><table width="205" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="20"><img src="core/common/images/timeico.gif" style="position: relative;left:-1px;" width="20" height="22" onclick="return showCalendar('expireTime');"/></td>
        </tr>
      </table></td>
    </tr>
    <tr>
