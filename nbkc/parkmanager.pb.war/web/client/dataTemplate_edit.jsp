...
<body>
<form action="<%=basePath %>dataTemplate!update.action" method="post" name="form1" id="form1">
<input type="hidden" value="${result.value.id}" name="dataTemplate.id"/>
<div class="basediv">
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="layertdleft100"><span class="psred">*</span>模板名称：</td>
				<td class="layerright"><input id="name" name="dataTemplate.name" type="text" class="inputauto" value="${result.value.name}"/></td>
			</tr>
		</table>
	</div>
