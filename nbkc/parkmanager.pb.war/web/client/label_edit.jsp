...
<body>
<form action="<%=basePath %>customerLabel!update.action" method="post" name="form1" id="form1">
<div class="basediv">
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="layerright">
					<input id="name" name="customerLabel.name" type="text" value="${result.value.name}" class="inputauto" />
					<input id="id" name="customerLabel.id" type="hidden" value="${result.value.id}" class="inputauto" />
				</td>
			</tr>
		</table>
	</div>
