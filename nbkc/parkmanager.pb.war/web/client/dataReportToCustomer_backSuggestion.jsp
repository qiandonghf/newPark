...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath %>dataReportToCustomer!back.action" method="post" name="form1" id="form1">
			<input type="hidden" value="${param.id}" name="id"/>
			<div class="basediv">
				<textarea id="suggestion" name="suggestion" style="height:140px;" class="textareaauto"></textarea></td>
			</div>
			<div class="buttondiv">
