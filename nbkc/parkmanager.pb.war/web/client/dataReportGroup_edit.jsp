...
<body>
<form action="<%=basePath %>dataReportGroup!update.action" method="post" name="form1" id="form1">
<input name="dataReportGroup.id" value="${result.value.id}" type="hidden"/>
<div class="basediv">
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="layertdleft100"><span class="psred">*</span>名称：</td>
				<td class="layerright"><input id="name" name="dataReportGroup.name" type="text" class="inputauto" value="${result.value.name}"/></td>
			</tr>
		</table>
	</div>
