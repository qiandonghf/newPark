		...
		$("#patentList").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_patentView")){%>
					content += "<img src=\"core/common/images/viewbtn.gif\" width=\"14\" height=\"14\" title=\"查看\" onclick=\"viewById('patent','"+id+"',650,245);\"  /> ";
					<%}%>
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_patentEdit")){%>
					content += "<img src=\"core/common/images/edit.gif\" width=\"14\" height=\"14\" title=\"编辑\" onclick=\"editById('patent','"+id+"',650,371);\"  /> ";
					<%}%>
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_patentDel")){%>
		...
		$("#copyrightList").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_copyrightView")){%>
					content += "<img src=\"core/common/images/viewbtn.gif\" width=\"14\" height=\"14\" title=\"查看\" onclick=\"viewById('copyright','"+id+"',500,322);\"  /> ";
					<%}%>
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_copyrightEdit")){%>
					content += "<img src=\"core/common/images/edit.gif\" width=\"14\" height=\"14\" title=\"编辑\" onclick=\"editById('copyright','"+id+"',500,459);\"  /> ";
					<%}%>
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_copyrightDel")){%>
		...
		$("#certificationList").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_certificationView")){%>
					content += "<img src=\"core/common/images/viewbtn.gif\" width=\"14\" height=\"14\" title=\"查看\" onclick=\"viewById('certification','"+id+"',500,280);\"  /> ";
					<%}%>
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_certificationEdit")){%>
					content += "<img src=\"core/common/images/edit.gif\" width=\"14\" height=\"14\" title=\"编辑\" onclick=\"editById('certification','"+id+"',500,407);\"  /> ";
					<%}%>
					<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_certificationDel")){%>
          ...
          <tr>
			...
			<div class="basediv tabswitch" style="margin:0px;" id="textname">
				<div class="emailtop">
					<div class="leftemail">
						<ul>
						<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_patentAdd")){ %>
			...
			<div class="basediv tabswitch" style="margin:0px;display:none" id="textname">
				<div class="emailtop">
					...
					<div class="leftemail">
						<ul>
						<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_copyrightAdd")){ %>
			...
			<div class="basediv tabswitch" style="margin:0px; display:none" id="textname">
				<div class="emailtop">
					...
					<div class="leftemail">
						<ul>
						<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_certificationAdd")){ %>
			...
			<div class="basediv tabswitch" style="margin:0px; display:none" id="textname">
				<div class="emailtop">
					...
					<div class="leftemail">
						<ul>
						<%if(PsActivator.getHttpSessionService().isInResourceMap("ps_serviceCenter_brandAdd")){ %>
