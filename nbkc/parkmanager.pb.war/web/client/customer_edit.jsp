		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="layerright"><enum:select id="type" name="customer.type" type="com.wiiy.crm.preferences.enums.CustomerTypeEnum" checked="result.value.type"/></td>
				...
				<tr>
					...
					<td style="white-space:nowrap;" class="layerright"><dd:select name="customer.customerTypeId" key="crm.0040" checked="result.value.customerTypeId"/></td>
				...
				<%-- <tr>
					<td class="layertdleft100">消息传递标识：</td>
					<td width="35%" class="layerright"><enum:radio defaultValue="NORMAL" name="customer.messageSend" type="com.wiiy.commons.preferences.enums.EntityStatus" checked="result.value.messageSend"/></td>
				</tr> --%>
				<tr>
			...
			<div class="divlays" style="margin:0px;">
		    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td colspan="3" class="layerright"><input id="formerName" name="customer.formerName" value="${result.value.formerName }" type="text" class="inputauto" /></td>
					</tr>
					<tr>
