			...
			function initList(){
				$("#list").jqGrid({
					...
					colModel: [
					    ...
					    {label:'内容', name:'content', align:"center",width:450}, 
			...
			<div class="emailtop" style="border: 1px solid #D9D9D9; background: #f6f6f6;">
				...
				<div class="leftemail">
					...
					<%if(PbActivator.getHttpSessionService().isInResourceMap("pb_customerServiceTrack_add")){ %>
						<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('添加服务轨迹','<%=basePath %>web/client/customerServiceTrack_add.jsp?serviceId=${result.value.id }',450,147);" class="" style="border-color: #f6f6f6;"><span><img src="core/common/images/emailadd.gif"></span>添加</li>
					<%} %>
					</ul>
				</div>
				<!--//leftemail-->
