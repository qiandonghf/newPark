...
<script type="text/javascript">
	...
	function setSelectedUser(user){
		$("#contectId").val(user.id);
		$("#contectName").val(user.realName);
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
	      ...
	      <td colspan="3" class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	          <tr>
	            <td width="370"><input id="customerId" name="contectInfo.customerId" type="hidden" /><input id="customerName" readonly="readonly" class="inputauto" onclick="fbStart('选择企业','<%=basePath%>customer!select.action',520,391);"/></td>
      ...
      <tr>
        ...
        <td class="layerright">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="10"><input id="contectId" name="contectInfo.contectId" value="<%=PbActivator.getSessionUser(request).getId() %>" type="hidden" class="inputauto" /><input id="contectName" value="<%=PbActivator.getSessionUser(request).getRealName() %>" readonly="readonly" type="text" class="inputauto" onclick="selectUser()" /></td>
      ...
      <tr>
        ...
        <td class="layerright" style="padding-bottom:2px;"><textarea id="content" name="contectInfo.content" style="height:100px;" class="textareaauto"></textarea></td>
      </tr>
      <tr>
