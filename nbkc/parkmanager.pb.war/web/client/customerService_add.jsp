			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="layerright" style="width:250px;">
						<table border="0" cellspacing="0" cellpadding="0" width="250">
							<tr>
								<td width=""><input id="customerId" value="" name="customerService.customerId" type="hidden" /><input id="customerName" name="customerService.customerName" value="" type="text" class="inputauto" readonly="readonly" /></td>
				...
				<tr>
			 	...
			 	<tr>
				 	...
				 	<td colspan="3" class="layerright"><textarea name="customerService.description"  class="textareaauto"  style="height:50px;"></textarea></td>
			 	</tr>
		 	</table>
	 	</div>
