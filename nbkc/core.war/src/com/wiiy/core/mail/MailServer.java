...
//						"text/html;charset=utf-8"));// 网页格式
				...
				DataSource fds = new FileDataSource(System.getProperty("org.springframework.osgi.web.deployer.tomcat.workspace")+"/core.war/common/images/"+CoreActivator.getAppConfig().getConfig("msgLogo").getParameter("name")); 
