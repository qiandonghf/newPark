...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>motto!save.action">
<div class="basediv">
<div class="divlays" style="margin:0px;height: 100px;widows: 200px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="layertdleft100">内容：</td>
      <td><textarea name="motto.motto" style="height: 100px;width: 200px;" class="textarea248"></textarea></td>
    </tr>
  </table>
</div>
