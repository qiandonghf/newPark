...
<script type="text/javascript"> 
	...
	function revoke(type,id){
		if('<%=ContactTypeEnum.INVESTMENTCONTACT%>' == type){
			var url="<%=url%>parkmanager.pb/investmentContact!revoke.action?id="+id;
			...
			var url="<%=url%>parkmanager.pb/rentOutContact!revoke.action?id="+id;
			$.post(url,function(data){
				showTip(data.result.msg,2000);
				setTimeout(function(){
					this.location.reload();
			...
			var url="<%=url%>parkmanager.pb/businessCenterContact!revoke.action?id="+id;
			$.post(url,function(data){
				showTip(data.result.msg,2000);
				setTimeout(function(){
					this.location.reload();
			...
			var url="<%=url%>parkmanager.pb/tenementCenterContact!revoke.action?id="+id;
			$.post(url,function(data){
				showTip(data.result.msg,2000);
				setTimeout(function(){
					this.location.reload();
			...
			var url="<%=url%>parkmanager.pb/financeContact!revoke.action?id="+id;
			$.post(url,function(data){
				showTip(data.result.msg,2000);
				setTimeout(function(){
					this.location.reload();
			...
			var url="<%=url%>parkmanager.pb/carportOutContact!revoke.action?id="+id;
			$.post(url,function(data){
				showTip(data.result.msg,2000);
				setTimeout(function(){
					this.location.reload();
			...
			var url="<%=url%>parkmanager.pb/customerServiceContact!revoke.action?id="+id;
			$.post(url,function(data){
				showTip(data.result.msg,2000);
				setTimeout(function(){
					this.location.reload();
	...
	function openRight(type,id){
		...
		var src = "<%=basePath%>contact!countersignView.action?type="+type+"& id="+id+"&currentTime="+currentTime;
	...
	function slide(id){
 	...
 	function reloadList(type,id){
 		var currentTime = new Date().getTime();
 		var src = "<%=basePath%>contact!myWaitCountersignList.action?type="+type+"& id ="+id+"& currentTime="+currentTime;
 	...
 	function refresh(){
 		this.location.href="<%=basePath%>contact!myWaitCountersignList.action";
 	}
</script>
