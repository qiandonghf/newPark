        ...
        <div class="parklist">
	      <ul>
	      	...
	      	<c:forEach items="${list }" var="dto">
	      		<%num++; %>
				<li><span><fmt:formatDate value="${dto.time }" pattern="yyyy-MM-dd" /></span><em><img src="images/ico3.gif" width="8" height="5" /></em><a href="enterpriseView.action?type=${dto.type }&categoryId=${dto.category.id }&id=${dto.id }&pos=${pager.page},${pager.records}.<%=num%>">${dto.name }</a></li>
			</c:forEach>
	      </ul>
	    </div>
