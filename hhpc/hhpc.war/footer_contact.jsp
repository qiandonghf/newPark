...
<div id="main" style="padding-top:25px;"> 
  ...
  <div id="mainright2"> 
	...
	<div class="parkinfo">     
    	<p class="leftimg">
           <img src="images/lxwm_earth.gif" width="182" height="276" /> 
        </p>
        <p class="righttext">                      
            <img src="images/lxwm_wz.jpg" width="339" height="55" />
            <span>
            	园区地址：${contactInfo.address }<br />
            	邮    编：${contactInfo.postCode }<br />
            	联系电话：${contactInfo.phone } <br />
            	传    真： ${contactInfo.fax }<br />
            	邮    箱：${contactInfo.email } <br />
            	网    址：<%=InitListener.webParam.getDomainName() %><br /> 
            </span>
        </p>
	</div> 
    <!---企业介绍具体内容结束----> 
