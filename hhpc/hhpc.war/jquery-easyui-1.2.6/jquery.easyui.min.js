...
var leftOffset = box.offset().left+box.outerWidth();
if(box.offset().left+box.outerWidth()+tip.width()>document.documentElement.clientWidth){
	leftOffset = document.documentElement.clientWidth-tip.width();
}
tip.css({display:"block",left:leftOffset,top:box.offset().top});
};
function _352(_355){
