...
public class ImageUtil {
	...
	public static final int MINHEIGHT = 240;
	public static final int MAXWIDTH = 600;
	public static final int MAXHEIGHT = 400;
	public static final String MINSTR = MINWIDTH+"-"+MINHEIGHT;//最小尺寸文字连接
	public static final String MAXSTR = MAXWIDTH+"-"+MAXHEIGHT;//最大尺寸文字连接
...
//			BufferedImage newBufferedImage = flipImage(oldBufferedImage);
	...
	public static void limitPhoto(String path){
		try {
			...
			BufferedImage scaleImage1 = ImageUtil.scaleImage(ImageIO.read(f), MINWIDTH, MINHEIGHT);
			BufferedImage scaleImage2 = ImageUtil.scaleImage(ImageIO.read(f), MAXWIDTH, MAXHEIGHT);
			String fileName = photoPath.substring(0,photoPath.lastIndexOf("."));
			String lastName = photoPath.substring(photoPath.lastIndexOf("."));
			String smallPhoto =fileName+MINSTR+lastName;
			String bigPhoto = fileName+MAXSTR+lastName;
