...
class JobTask extends TimerTask{
	...
	class CheckJobTask extends TimerTask{
		...
		public void run() {
			...
			RoomStatusCheckJob roomStatusCheckJob = new RoomStatusCheckJob(applicationContext,dataCheck);
			ContractExpiredCheckJob contractExpiredCheckJob = new ContractExpiredCheckJob(applicationContext,dataCheck);
			roomStatusCheckJob.init();
			contractExpiredCheckJob.init();
