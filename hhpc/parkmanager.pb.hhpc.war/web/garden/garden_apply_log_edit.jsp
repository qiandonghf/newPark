...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath %>garden!applyLogUpdate.action" method="post" name="form1" id="form1">
			<input type="hidden" value="${result.value.id}" name="gardenApplyLog.id"/>
			<div class="basediv">
			<div class="divlays" style="margin:0px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="layerright"><textarea name="gardenApplyLog.content" style="height:80px;resize:none;overflow:hidden;overflow-y:auto;" class="inputauto">${result.value.content }</textarea></td>
					</tr>
				</table>
			</div>
