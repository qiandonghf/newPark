		...
		<div class="emailtop">
			<div class="leftemail">
				<ul>
					...
					<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="slide('meterlayer');"><span><img src="core/common/images/print_16x16.gif"/></span>打印<em class="em"><img src="core/common/images/arrow.png" /></em>
