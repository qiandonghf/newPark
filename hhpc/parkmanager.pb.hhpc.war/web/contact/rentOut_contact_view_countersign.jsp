...
<div class="titlebg">会签信息：</div>
      ...
      <tr>
        ...
        <td class="layerright" style="padding-top:4px;" colspan="3"><textarea name="textarea" id="opinion3Txt" <c:if test="${result.value.opinion3Id ne userId || result.value.opinion3 ne null}">readonly="readonly"</c:if> class="textareaauto"  style="height:50px;">${result.value.opinion3 }</textarea></td>
        <td width="6%"><input type="hidden" id="headId" value="${result.value.opinion3Id }" /><label id="headLab">
	        ...
	        <c:if test="${result.value.opinion3Id eq null && result.value.opinion3 eq null }">
	        	<input name="Submit" type="button" onclick="send('opinion3');" class="sentbtn1" value="发送" />
	        </c:if>
        </label></td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="tsy-h80">管委会财务部审核意见：</span></td>
        <td class="layerright" style="padding-top:4px;" colspan="3"><textarea name="textarea" id="opinion4Txt" <c:if test="${result.value.opinion4Id ne userId || result.value.opinion4 ne null}">readonly="readonly"</c:if> class="textareaauto"  style="height:50px;">${result.value.opinion4 }</textarea></td>
        <td width="6%"><input type="hidden" id="headId" value="${result.value.opinion4Id }" /><label id="headLab">
	        ...
	        <c:if test="${result.value.opinion4Id eq null && result.value.opinion4 eq null }">
	        	<input name="Submit" type="button" onclick="send('opinion4');" class="sentbtn1" value="发送" />
	        </c:if>
        </label></td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="tsy-h80">南都物业服务中心验房审核意见：</span></td>
        <td class="layerright" style="padding-top:4px;" colspan="3"><textarea name="textarea" id="opinion5Txt" <c:if test="${result.value.opinion5Id ne userId || result.value.opinion5 ne null}">readonly="readonly"</c:if> class="textareaauto"  style="height:50px;">${result.value.opinion5 }</textarea></td>
        <td width="6%"><input type="hidden" id="headId" value="${result.value.opinion5Id }" /><label id="headLab">
	        ...
	        <c:if test="${result.value.opinion5Id eq null && result.value.opinion5 eq null }">
	        	<input name="Submit" type="button" onclick="send('opinion5');" class="sentbtn1" value="发送" />
	        </c:if>
        </label></td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="tsy-h80">南都物业服务中心（财务）审核意见：</span></td>
        <td class="layerright" style="padding-top:4px;" colspan="3"><textarea name="textarea" id="opinion6Txt" <c:if test="${result.value.opinion6Id ne userId || result.value.opinion6 ne null}">readonly="readonly"</c:if> class="textareaauto"  style="height:50px;">${result.value.opinion6 }</textarea></td>
        <td width="6%"><input type="hidden" id="headId" value="${result.value.opinion6Id }" /><label id="headLab">
	        ...
	        <c:if test="${result.value.opinion6Id eq null && result.value.opinion6 eq null }">
	        	<input name="Submit" type="button" onclick="send('opinion6');" class="sentbtn1" value="发送" />
	        </c:if>
        </label></td>
      </tr>
      <tr>
