					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
       						 <tbody><tr>
							          ...
							          <input id="investmentId" name="investmentContact.investmentId" type="hidden" ><input id="investmentName" name="investmentContact.investmentName" class="inputauto" onclick="selectInvestment()" readonly="readonly"></td>
							...
							<td class="layerright">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="80"><input id="staff" name="investmentContact.staff" type="text" class="inputauto" readonly="readonly"/></td>
						...
						<tr>
							...
							<td class="layerright">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="80"><input id="regCapital" name="investmentContact.regCapital" type="text" class="inputauto" readonly="readonly"/></td>
							...
							<td class="layerright">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="80"><input id="investCapital" name="investmentContact.investCapital" type="text" class="inputauto" readonly="readonly"/></td>
										<td width="40" align="center">万元</td>
										<td>&nbsp;</td>
									</tr>
								</table>
						...
						<tr>
							...
							<td class="layerright">
								<table width="50%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td >
											<td><input  id="officeArea" name="investmentContact.officeArea" type="text" class="inputauto" readonly="readonly"/></td>
							...
							<td class="layerright">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="80"><input id="outputValue" name="investmentContact.outputValue" type="text" class="inputauto" readonly="readonly"/></td>
										<td width="40" align="center">万元</td>
										<td>&nbsp;</td>
									</tr>
								</table>
						...
						<tr>
							...
							<td colspan="3" class="layerright" style="padding-top:2px;"><textarea id="businessScope" name="investmentContact.businessScope"  class="textareaauto"  rows="2" readonly="readonly"></textarea></td>
						</tr>
						<tr>
							<td class="layertdleft100">情况说明：</td>
							<td colspan="3" class="layerright" style="padding-top:2px;"> <textarea name="investmentContact.description"  class="textareaauto"  rows="2"></textarea></td>
						</tr>
					</table>
				</div>
