					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="layerright" >
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="35"><input id="responsibleId" value="${result.value.responsibleId }" name="carportOutContact.responsibleId" type="hidden" class="inputauto" /><input id="responsible" name="carportOutContact.responsible" readonly="readonly" value="${result.value.responsible.realName }" type="text" class="inputauto" onclick="selectUser()" /></td>
							...
							<td class="layertdleft120"><span class="psred">*</span>原租赁期限：</td>
					      	<td class="layerright">
						      	<table border="0" cellspacing="0" cellpadding="10">
						        	<tbody>
							          	<tr>
								            <td width="80"><input id="rentStart" name="carportOutContact.rentStart" value="${result.value.rentStart}" type="text" readonly="readonly" class="inputauto"  onclick="showCalendar('rentStart');" /></td>
								            ...
								            <td>&nbsp;至&nbsp;</td>
								            <td width="80"><input id="rentEnd" name="carportOutContact.rentEnd" value="${result.value.rentEnd}" type="text" readonly="readonly" class="inputauto" onclick="showCalendar('rentEnd');" /></td>
							...
							<td class="layertdleft120"><span class="psred">*</span>退赁时间核实：</td>
					      	<td class="layerright">
						      	<table border="0" cellspacing="0" cellpadding="10">
						        	<tbody>
							          	<tr>
								            <td width="160"><input id="rentOutStart" name="carportOutContact.rentOutStart" value="${result.value.rentOutStart}" type="text" readonly="readonly" class="inputauto"  onclick="showCalendar('rentOutStart');" /></td>
								            ...
								            <td>&nbsp;至&nbsp;</td>
								            <td width="160"><input id="rentOutEnd" name="carportOutContact.rentOutEnd" value="${result.value.rentOutStart}" type="text" readonly="readonly" class="inputauto" onclick="showCalendar('rentOutEnd');" /></td>
