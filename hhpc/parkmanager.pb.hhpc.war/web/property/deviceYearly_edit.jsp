				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="21%" class="layerright">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><input id="operationDate" value='<fmt:formatDate value="${result.value.operationDate}" pattern="yyyy-MM-dd"/>' name="deviceYearly.operationDate" type="text" readonly="readonly" class="inputauto" onclick="showCalendar('operationDate');"/></td>
