...
<script type="text/javascript">
	...
	function checkForm(){
		 if(notNull("visitingPerson","走访人员")
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
       ...
       <tr>
        ...
        <td class="layerright"><input id="visitingPerson" name="contectInfo.visitingPerson" class="inputauto" type="text"/></td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="psred">*</span>接待人员：</td>
        <td class="layerright"><input id="deskClerk" name="contectInfo.deskClerk" class="inputauto" type="text"/></td>
      </tr>
      <tr>
