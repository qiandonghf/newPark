...
<script type="text/javascript">
	...
	function checkForm(){
		...
		if (notNull("customerName","企业名称") && notNull("name","申报项目名称")&& checkInput("applyYear","申报年度") 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="350"><input id="customerId" name="projectApply.customerId" type="hidden" /><input id="customerName" type="text" class="inputauto" readonly="readonly" onclick="fbStart('选择企业','<%=basePath%>customer!select.action',520,400);"/></td>
     ...
     <tr>
      ...
      <td class="layerright">
      <input id="productCode" name="projectApply.productCode" type="text" class="inputauto" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="layertdleft100">项目/产品名称：</td>
      <td class="layerright">
    ...
    <tr>
      ...
      <td class="layerright">
		<dd:select key="crm.0007" name="projectApply.applyTypeId" id="applyTypeId"/>
	</td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>申报状态：</td>
      <td class="layerright">
      <enum:select type="com.wiiy.crm.preferences.enums.ProjectApplyStatusEnum" defaultValue="SUCCESS" name="projectApply.applyState" id="applyState"/>
	</td>
    </tr>
    ...
    <tr>
      ...
      <td class="layerright"><table width="205" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><img src="core/common/images/timeico.gif" style="position: relative;left:-1px;" width="20" height="22" onclick="return showCalendar('starttime');"/></td>
        </tr>
      </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="layertdleft100">资助金额：</td>
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td width="180"><input name="projectApply.realAmount" type="text" class="inputauto" id="realAmount" onkeyup="value=value.replace(/[^\d\.]/g,'')"/></td>
          <td>&nbsp;万元</td>
        </tr>
      </table></td>
    </tr>
