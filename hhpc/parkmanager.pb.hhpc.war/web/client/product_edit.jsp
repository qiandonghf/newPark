...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="layerright">
      <dd:select name="product.technicId" key="crm.0002" checked="result.value.technicId" id="technicId"/>
      </td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>产品阶段：</td>
      <td class="layerright">
		<dd:select name="product.stageId" key="crm.0013" checked="result.value.stageId" id="stageId"/>
	</td>
    </tr>
