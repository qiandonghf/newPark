				...
				<tr>
					...
					<td class="layerright" style="width:250px;">
						<table border="0" cellspacing="0" cellpadding="0" width="250">
							<tr>
								<td width=""><input id="customerId" value="${result.value.customerId }" name="customerService.customerId" type="hidden" /><input id="customerName" value="${result.value.customerName }" type="text" class="inputauto" /></td>
