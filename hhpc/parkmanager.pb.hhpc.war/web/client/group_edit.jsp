	...
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="layerright"><enum:radio name="customerCategory.ownerEnum" checked="result.value.ownerEnum" styleClass="ownerEnum" type="com.wiiy.crm.preferences.enums.OwnerEnum"/></td>
			</tr>
			<% } %>
		</table>
	</div>
