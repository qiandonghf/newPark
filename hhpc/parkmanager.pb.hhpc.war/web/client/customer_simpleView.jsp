...
<script type="text/javascript">
	...
	function viewById(test,id,h,w){
		fbStart('查看走访记录',"<%=basePath%>"+test+"!view.action?id="+id,h,w);
	}
	function editById(test,id,h,w){
		fbStart('编辑走访记录',"<%=basePath%>"+test+"!edit.action?id="+id,h,w);
	}
				...
				<div class="pm_view_right">
					...
					<div class="apptab" id="tableid">
						<ul>
							...
							<li class="apptabli" onclick="tabSwitch('apptabli','apptabliover','tabswitch',4)">走访记录</li>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="layerright">
										...
										<%
											Result<Customer> r = (Result<Customer>)request.getAttribute("result");
					...
					<div class="basediv tabswitch" style="margin:0px; display:none;" id="textname">
						<div class="emailtop">
							<div class="leftemail">
								<ul>
									<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('新建走访记录','<%=basePath %>contectInfo!addByCustomerId.action?id=${result.value.id}',550,300);"><span><img src="core/common/images/emailadd.gif" /></span>新建</li>
								</ul>
							</div>
						</div>
