...
<%@page import="com.wiiy.crm.entity.ContectInfo"%>
...
<script type="text/javascript">
	...
	function checkForm(){
		 if(notNull("customerName","企业名称")
			 	&&notNull("visitingPerson","走访人员")
				&&notNull("deskClerk","接待人员")
				&&checkSelect("type","走访类型")
				&&notNull("startTime","走访日期")
				&&notNull("content","内容")
		 	){
...
<div class="basediv">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
        <td class="layertdleft100"><span class="psred">*</span>走访人员：</td>
        <td width="33%" class="layerright"><input id="visitingPerson" name="contectInfo.visitingPerson" class="inputauto" value="${result.value.visitingPerson }" type="text"/></td>
        <td class="layertdleft100"><span class="psred">*</span>接待人员：</td>
        <td width="33%" class="layerright"><input id="deskClerk" name="contectInfo.deskClerk" class="inputauto" value="${result.value.deskClerk }" type="text"/></td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="psred">*</span>走访类型：</td>
        <td class="layerright">
      		<dd:select id="type" name="contectInfo.typeId" key="crm.0016" checked="result.value.typeId"/>
    	</td>
        <td class="layertdleft100"><span class="psred">*</span>走访日期：</td>
        <td class="layerright">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="70">
					...
					<td style="">
					<%
					Result<ContectInfo> result = (Result<ContectInfo>)request.getAttribute("result"); 
      ...
      <tr>
        ...
        <td class="layerright" style="padding-bottom:2px;" colspan="3"><textarea id="content" name="contectInfo.content" style="height:100px;resize:none;" class="inputauto">${result.value.content }</textarea></td>
      </tr>
      <tr>
        <td class="layertdleft100">备注：</td>
        <td class="layerright" style="padding-bottom:2px;" colspan="3"><textarea name="contectInfo.memo" style="height:50px;resize:none;" class="inputauto">${result.value.memo }</textarea></td>
      </tr>
    </table>
