...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="layerright">
      <input id="productCode" name="projectApply.productCode" value="${result.value.productCode }" type="text" class="inputauto" /></td>
    </tr>
	<tr>
     ...
     <tr>
      ...
      <td class="layerright">
		<dd:select key="crm.0007" name="projectApply.applyTypeId" id="applyTypeId" checked="result.value.applyTypeId" />
	</td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>申报状态：</td>
      <td class="layerright">
      <enum:select type="com.wiiy.crm.preferences.enums.ProjectApplyStatusEnum" name="projectApply.applyState" id="applyState" defaultValue="${result.value.applyState }"/>
	</td>
    </tr>
    ...
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td width="180"><input name="projectApply.realAmount" type="text" class="inputauto" id="realAmount" value="<fmt:formatNumber value="${result.value.realAmount}" pattern="#0.00"/>" onkeyup="value=value.replace(/[^\d\.]/g,'')"/></td>
          <td>&nbsp;万元</td>
        </tr>
      </table></td>
    </tr>
