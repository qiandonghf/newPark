...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="<%=basePath %>customerRiskCapital!save.action" method="post" name="form1" id="form1">
			<input type="hidden" value="${result.value.id}" name="customerRiskCapital.customerId"/>
			<div class="basediv">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="layerright">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><input id="time" name="customerRiskCapital.time" onclick="showCalendar('time');" readonly="readonly" class="inputauto" /></td>
					...
					<tr>
						...
						<td class="layerright">
							<input name="customerRiskCapital.money" type="text" class="inputauto" style="width:45px;"/> 万元 <dd:select name="customerRiskCapital.currencyTypeId" key="crm.0005"/>
						</td>
						<td class="layertdleft100"><span class="psred">*</span>机构名称：</td>
						<td class="layerright"><input name="customerRiskCapital.orgName" class="inputauto"/></td>
					</tr>
					<tr>
						<td class="layertdleft100">备注：</td>
						<td class="layerright" colspan="3"><textarea name="customerRiskCapital.memo" style="resize:none;height:80px;" class="inputauto"></textarea></td>
					</tr>
				</table>
			</div>
