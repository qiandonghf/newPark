...
<div class="basediv" style="height:292px; overflow-y:auto; overflow-x:hidden">
  <div class="divlays" style="margin:0px;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td class="layertdleft100">授权公告日期：</td>
        <td colspan="3" class="layerright">
	        <table width="100%" border="0" cellspacing="0" cellpadding="10">
	          <tr>
	            <td width="120">
					<search:choose dataType="java.util.Date" field="buyTime" op="ge">
	            		<input id="buyTime1" class="data inputauto" onclick="return showCalendar('buyTime1')"/>
	            	</search:choose>
				</td>
	            <td width="20" ><img src="core/common/images/timeico.gif" width="20" height="22" style="position: relative;left:-1px;" onclick="return showCalendar('buyTime1');" /></td>
	          	<td width="10" align="center">-</td>
	          	<td width="120">
					<search:choose dataType="java.util.Date" field="buyTime" op="le">
	            		<input id="buyTime2" class="data inputauto" onclick="return showCalendar('buyTime2')"/>
	            	</search:choose>
				</td>
	            <td width="20" ><img src="core/common/images/timeico.gif" width="20" height="22" style="position: relative;left:-1px;" onclick="return showCalendar('buyTime2');" /></td>
	          	<td></td>
	          </tr>
	        </table>
	    </td>
        ...
        <td colspan="3" class="layerright">
	        <table width="100%" border="0" cellspacing="0" cellpadding="10">
	          <tr>
	            ...
	            <td width="20" ><img src="core/common/images/timeico.gif" width="20" height="22" style="position: relative;left:-1px;" onclick="return showCalendar('expireTime1');" /></td>
	          	<td width="10" align="center">-</td>
	          	<td width="120">
	            ...
	            <td width="20" ><img src="core/common/images/timeico.gif" width="20" height="22" style="position: relative;left:-1px;" onclick="return showCalendar('expireTime2');" /></td>
      ...
      <tr>
        <td class="layertdleft100">获得方式：</td>
        <td class="layerright">
        	<search:choose dataType="string" field="sourceId" op="eq">
					<dd:select styleClass="data" key="crm.0012"/>
			</search:choose>
        </td>
      </tr>
      <tr>
