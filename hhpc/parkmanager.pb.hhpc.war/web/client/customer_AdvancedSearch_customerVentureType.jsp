<%@page import="com.wiiy.crm.dto.CustomerVentureTypeSearchResultDto"%>
...
<body>
	<div class="pm_msglist" id="msglist">
		...
		<div class="overflowAuto" id="overflowAuto">
			...
			<thead>
				<tr class="table_titlebgcolor" style="font-weight:bold;">
					<%
						...
						List<DataDict> enterpriseTypeList = (List<DataDict>)request.getAttribute("enterpriseTypeList");
						for(DataDict dd : enterpriseTypeList){
							out.println("<th scope='col'>"+dd.getDataValue()+"</th>");
						}
					%>
				</tr>
			</thead>
			<tbody>
				<%
				Result<List<CustomerVentureTypeSearchResultDto>> result = (Result<List<CustomerVentureTypeSearchResultDto>>)request.getAttribute("result");
				List<CustomerVentureTypeSearchResultDto> list = result.getValue();
				if(list!=null)
