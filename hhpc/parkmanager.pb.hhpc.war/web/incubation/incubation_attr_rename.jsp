...
<script type="text/javascript" src="core/common/floatbox/floatbox.js"></script>
	...
	<body>
		<form action="<%=basePath %>investment!attrUpdate.action" method="post" name="form1" id="form1">
				...
				<div class="divlays" style="margin:0px;">
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="layerright"><input id="name" name="name" type="text" class="inputauto" value="${result.value.name }"/></td>
						</tr>
					</table>
				</div>
