...
var t_loc=loc.substring(7,loc.length);
t_loc=t_loc.substring(0,t_loc.indexOf('/'));
t_loc='http://'+t_loc+'/core/upload.action';
var uploadify = {
	uploader:t_loc,
	swf:"core/common/uploadify-v3.1/uploadify.swf",
	width:80,
	height:20,
	queueID:"fileQueue",
	buttonText:"浏览",
	...
	directory:{
		...
		fileTypeDesc:"支持格式:txt/doc/zip/rar/pdf",
		fileTypeExts:"*.txt;*.doc;*.zip;*.rar;*.pdf;"
	}
};
