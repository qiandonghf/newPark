               	  ...
               	  [{
               		...
               		],[
               		{
               			...
               			func: function() {
               				var type = $(this).find("input").val();
               				var id = $(this).find("input").next().val();
               				var url="<%=url%>parkmanager.pb/financeContact!setStatus.action?id="+id+"&type="+type+"&status=ACCEPT";
               		...
               		},
               		{
               			...
               			func: function() {
               				var type = $(this).find("input").val();
               				var id = $(this).find("input").next().val();
               				var url="<%=url%>parkmanager.pb/financeContact!setStatus.action?id="+id+"&type="+type+"&status=CLOSE";
               				$.post(url,function(data){
               					var msg = data.result.msg;
               					showTip(msg);
               					if(data.result.success){
               		...
               		},
               		{
               			...
               			func: function() {
               				var type = $(this).find("input").val();
               				var id = $(this).find("input").next().val();
               				var url="<%=url%>parkmanager.pb/financeContact!setStatus.action?id="+id+"&type="+type+"&status=SUSPEND";
               				$.post(url,function(data){
               					var msg = data.result.msg;
               					showTip(msg);
               					if(data.result.success){
               	 ...
               	 <%--  ,[
               		{
               			...
               			func: function() {
               				var type = $(this).find("input").val();
               				var id = $(this).find("input").next().val();
               				var url="<%=url%>parkmanager.pb/financeContact!setSolved.action?id="+id+"&type="+type+"&resolveStatus=SOLVED";
               				$.post(url,function(data){
               					var msg = data.result.msg;
               					showTip(msg);
               					if(data.result.success){
               		...
               		},
               		{
               			...
               			func: function() {
               				var type = $(this).find("input").val();
               				var id = $(this).find("input").next().val();
               				var url="<%=url%>parkmanager.pb/financeContact!setSolved.action?id="+id+"&type="+type+"&resolveStatus=UNSOLVED";
               				$.post(url,function(data){
               					var msg = data.result.msg;
               					showTip(msg);
               					if(data.result.success){
               		...
               		},
               		{
               			...
               			func: function() {
               				var type = $(this).find("input").val();
               				var id = $(this).find("input").next().val();
               				var url="<%=url%>parkmanager.pb/financeContact!setSolved.action?id="+id+"&type="+type+"&resolveStatus=PARTSOLVED";
               				$.post(url,function(data){
               					var msg = data.result.msg;
               					showTip(msg);
               					if(data.result.success){
               		...
               		,[
               	  {
               			...
               			func: function() {
               				if(confirm("你确定要删除")){
               					var type = $(this).find("input").val();
               					var id = $(this).find("input").next().val();
               						$.post("<%=url%>parkmanager.pb/financeContact!delete.action?id="+id,function(data){
