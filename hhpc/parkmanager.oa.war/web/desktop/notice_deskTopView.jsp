...
function downLoad(path,name){
	var url = "<%=basePath%>notice!export.action?path="+path+"&fileName="+name;
...
<div class="oaworknews"  id="resizable" style="overflow-x:hidden; overflow-y:auto;">
	<div class="newview">
		...
		<h2><fmt:formatDate value="${result.value.time }" pattern="yyyy-MM-dd"/> 发布              发布者：${result.value.issuer }       来源：${result.value.incubator }</h2>
		<ul>
			<li>
