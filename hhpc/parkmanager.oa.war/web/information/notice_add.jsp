...
<body>
<form action="<%=basePath %>notice!save.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
             <td width="150"><input id="issueTime" name="notice.issueTime" readonly="readonly" type="text" class="inputauto" onclick="showCalendar('issueTime')"/></td>
