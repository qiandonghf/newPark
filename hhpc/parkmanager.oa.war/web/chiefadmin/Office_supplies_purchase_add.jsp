...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>supplyPurchaseApply!save.action">
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
	<!--//titlebg-->
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="390">
	          ...
	          <input id="supplyName" name="supplyPurchase.supply.name"  readonly="readonly" class="inputauto" onclick="fbStart('选择商品','<%=basePath %>supply!select.action',520,400);"/>
          </td>
          <td width="20">
    ...
    <tr>
      ...
      <td class="layerright">     
      	<input id="supplySpec" value="" name="supplyPurchase.supply.spec" type="text" class="inputauto" readonly="readonly" />
      </td>
    </tr>
     <tr>
      ...
      <td class="layerright">
	  <label>
	  <input id="amount" name="supplyPurchase.amount" type="text" class="inputauto" style="padding-left:2px; height:20px; line-height:20px; border:1px solid #e0e0e0;width: 100px;" onkeyup="checkAmount(this)"/>
	  </label>	  </td>
     </tr>
     <tr>
      <td class="layertdleft100"><span class="psred">*</span>单位：</td>
      <td class="layerright">     	
      	<input id="supplyUnit" value="" name="supplyPurchase.supply.unit" type="text" class="inputauto" readonly="readonly"/>
      </td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>单价：</td>
      <td class="layerright">
      	<input id="price" name="supplyPurchase.price" type="text" class="inputauto" onkeyup="checkPrice(this)"/>
      </td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>总额：</td>
      <td class="layerright">
      	<input id="totalPrice" name="supplyPurchase.totalPrice" type="text" class="inputauto" readonly="readonly"/>
      </td>
    </tr>
    <tr>
      ...
      <td class="layerright"><table width="110px" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="80">
          	<input id="applyTime" name="supplyPurchase.applyTime" type="text" readonly="readonly" class="inputauto" onclick="return showCalendar('applyTime');"/></td>
      ...
      <td class="layerright">
      	<input id="purchaser" name="supplyPurchase.purchaser" type="text" class="inputauto" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="layerright"><textarea id="comment" name="supplyPurchase.comment" rows="8" class="textareaauto"></textarea></td>
      </tr>
  </table>
</div>
<!--//divlay-->
