...
<script type="text/javascript">
	...
	function initForm(){
		$("#form1").validate({
			rules:{
				"meetingAtt.meeting.title":"required",
				"meetingAtt.meeting.meetingTypeId":"required",
				"meetingAtt.meeting.meetingTime":"required"
			},
			messages: {
				"meetingAtt.meeting.title":"请填写会议主题",
				"meetingAtt.meeting.meetingTypeId":"请选择会议类型",
				"meetingAtt.meeting.meetingTime":"请选择会议时间"
			},
...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath %>meetingAtt!save.action">
<div class="basediv">
<div class="divlays" style="margin:0px;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
 		<tr>
	        <td class="layertdleft100" ><span class="psred">*</span>会议主题：</td>
	        <td class="layerright"><label><input name="meetingAtt.meeting.title" type="text" class="inputauto"/></label></td>
     	</tr>
     	<tr>
	        ...
	        <td class="layerright">
				...
				<tr>
					<td><input id="meetingTime" name="meetingAtt.meeting.meetingTime" type="text" class="inputauto" readonly="readonly" onclick="return showCalendar('meetingTime','y-mm-dd');"/></td>
		...
		<tr>
			...
			<td class="layerright"><dd:select name="meetingAtt.meeting.meetingTypeId" key="oa.0008"/></td>
		</tr>
		<tr>
	        <td class="layertdleft100">添加附件：</td>
	       	<td class="layerright" height="40">
	       		...
	       		<input id="newName" name="meetingAtt.newName" type="hidden"/>
				<table><tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		    <tr>
		      ...
		      <td colspan="3"><span class="layerright">
		        <textarea name="meetingAtt.meeting.content" rows="5" class="textareaauto"></textarea>
		      </span></td>
		    </tr>
	   </table>
  </table>
