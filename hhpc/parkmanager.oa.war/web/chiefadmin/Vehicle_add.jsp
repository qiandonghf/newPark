...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>car!save.action">
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
	<!--//titlebg-->
...
<div class="divlays" style="margin:0px;">
    ...
    <tr>
      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="layerright"><input name="car.licenseNo" type="text" class="inputauto" /></td>
            </tr>
          <tr>
            <td class="layertdleft100"><span class="psred">*</span>状态：</td>
            <td class="layerright">
          		<enum:select type="com.wiiy.oa.preferences.enums.CarStatusEnum" name="car.status" styleClass="incubated"/>  
            </td>
          </tr>
          <tr>
            <td class="layertdleft100"><span class="psred">*</span>车辆类型：</td>
            <td class="layerright">
            	<dd:select id="carTypeId" name="car.carTypeId" key="oa.0001"/> 
            </td>
          </tr>
          <tr>
            <td class="layertdleft100">厂家型号：</td>
            <td class="layerright">
            	<input name="car.factoryModel" type="text" class="inputauto" />
            </td>
          </tr>
          <tr>
            <td class="layertdleft100">发动机号：</td>
            <td class="layerright">
              <input name="car.engineNumber" type="text" class="inputauto" />
            </td>
          </tr>
          <tr>
            ...
            <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="175"><input id="insuranceDate" name="car.insuranceDate" type="text" class="inputauto" onclick="return showCalendar('insuranceDate', 'y-mm-dd');"/></td>
          ...
          <tr>
            ...
            <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="175"><input id="annualDate" name="car.annualDate" type="text" class="inputauto" onclick="return showCalendar('annualDate', 'y-mm-dd');"/></td>
      ...
      <td width="260" valign="top"><table style=" padding-top:3px;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="186"><img id="car_imagery_img" class="oa_img" src="core/common/images/nopic.jpg" width="180" height="185" /></td>
            ...
            <td valign="top">
            	...
            	<input id="photo" type="hidden" name="car.photo"/>	
           	</td>
          </tr>
      </table></td>
    </tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright" style="width:193px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="175"><input id="buyDate" name="car.buyDate" type="text" class="inputauto" onclick="return showCalendar('buyDate', 'y-mm-dd');"/></td>
          <td width="20" align="center"><img src="core/common/images/timeico.gif" style="style="relative; left:-1px;"" width="20" height="22" onclick="return showCalendar('buyDate', 'y-mm-dd');"/></td>
          <td></td>
        </tr>
      </table></td>
      <td class="layertdleft100">驾驶员：</td>
      <td class="layerright"><input name="car.pilot" type="text" class="inputauto" /></td>
    </tr>
  </table>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><textarea name="car.memo" rows="5" class="textareaauto" style="width:468px;" ></textarea></td>
    </tr>
  </table>
</div>
<!--//divlay-->
