  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          <td width="370">
	          	  ...
	          	  <input id="supplyName" name="supplyStockIn.supply.name" readonly="readonly" class="inputauto"  onclick="fbStart('选择商品','<%=basePath %>supply!select.action',520,400);"/>
	          </td>
	          <td width="20" align="center">
	          	<img width="20" height="22"  style="position: relative;left:-3px;" onclick="fbStart('选择商品','<%=basePath %>supply!select.action',520,400);" src="core/common/images/outdiv.gif"/>
	          </td>
	       </tr>
	      </table>
      </td>
    ...
    <tr>
      ...
      <td class="layerright"><label>
        <input name="supplyStockIn.supplier" type="text" class="inputauto" />
      </label></td>
      </tr>
    <tr>
      ...
      <td class="layerright">
	  <label>
	  <input name="supplyStockIn.price" type="text" class="inputauto" onkeyup="checkAmount(this)" />
	  </label>	  </td>
      </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>总数：</td>
      <td class="layerright"><input id="amount" name="supplyStockIn.amount" type="text" class="inputauto" onkeyup="checkAmount(this)"/></td>
    </tr>
    <tr>
      ...
      <td class="layerright">
      	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      	  <tr>
        	  <td width="370">
        	  	<input id="inTime" name="supplyStockIn.inTime" readonly="readonly" type="text" class="inputauto"  onclick="return showCalendar('inTime');"/>
        	  </td>
        	  <td width="20" align="center">
        	  	<img src="core/common/images/timeico.gif"  width="20" height="22"  style="position: relative;left:-3px;" onclick="return showCalendar('inTime');"/>
        	  </td>
         </tr>
    	</table>
      </td>
    ...
    <tr>
      ...
      <td class="layerright"><input name="supplyStockIn.purchaser" type="text" class="inputauto" /></td>
      </tr>
  </table>
</div>
<!--//divlay-->
