...
<script type="text/javascript">
	...
	function editById(id){
		fbStart('车辆编辑','<%=basePath%>car!edit.action?id='+id,600,334);
	}
...
<div class="emailtop">
	<div class="leftemail">
		<ul>
			<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('车辆新建','<%=basePath %>web/chiefadmin/Vehicle_add.jsp',600,334);"><span><img src="core/common/images/emailadd.gif"/></span>新建</li>
