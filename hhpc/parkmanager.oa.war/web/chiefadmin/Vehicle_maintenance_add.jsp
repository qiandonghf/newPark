...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>carFix!save.action">
<!--basediv-->
<div class="basediv">
    <!--divlay-->
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="153">
            <input id="carLicenseNo" name="carFix.licenseNo" type="text" class="inputauto" onclick="fbStart('车辆选择','<%=basePath%>car!carSelect.action',400,235);"/>
            <input id="carId" name="carFix.carId" type="hidden"/>
          </td>
          <td><img src="core/common/images/outdiv.gif" width="20" height="22" style="cursor:pointer;relative; left:-1px;" onclick="fbStart('车辆选择','<%=basePath%>car!carSelect.action',400,235);"/></td>
        </tr>
      </table></td>
      </tr>
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="153">
            <input id="fixDate" name="carFix.fixDate" type="text" class="inputauto" onclick="return showCalendar('fixDate', 'y-mm-dd');"/>
          </td>
    ...
    <tr>
      ...
      <td><input name="carFix.operator" type="text" class="input170" /></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>维修类型：</td>
      <td class="layerright">
      	<dd:select id="carFixTypeId" name="carFix.carFixTypeId" key="oa.0002" />
      </td>
    </tr>
    <tr>
      <td class="layertdleft100">费用：</td>
      <td><input name="carFix.fee" type="text" class="input170" /> 元</td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>维护原因：</td>
      <td class="layerright" style="padding-bottom:2px;"><label>
        <textarea name="carFix.reason" rows="5" class="textareaauto"></textarea>
      </label></td>
    </tr>
    <tr>
      <td class="layertdleft100">备注：</td>
      <td class="layerright"><label>
        <textarea name="carFix.memo" rows="3" class="textareaauto"></textarea>
      </label></td>
      </tr>
  </table>
</div>
