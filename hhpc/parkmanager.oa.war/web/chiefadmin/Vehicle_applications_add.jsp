...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <tr>
          <td width="146">
            <input id="carLicenseNo" name="carApply.licenseNo" type="text" class="inputauto" onclick="fbStart('车辆选择','<%=basePath%>car!carSelect.action',400,235);"/>
            <input id="carId" name="carApply.carId" type="hidden"/>
          </td>
    ...
    <tr>
      ...
      <td width="33%" class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="193">
          	<input id="applyer" name="carApply.usePersons" readonly="readonly" type="text" class="inputauto" onclick="fbStart('选择用车人','<%=BaseAction.rootLocation %>/core/user!select2.action',520,400);"/></td>
      ...
      <td class="layerright">
      	<input type="hidden" name="carApply.creator" value="<%=OaActivator.getSessionUser(request).getRealName()%>"/>
