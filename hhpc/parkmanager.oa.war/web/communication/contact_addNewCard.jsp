...
<div class="basediv">
<div class="divlays">
	<input id="ownerId" name="card.ownerId" value="<%=OaActivator.getSessionUser(request).getId()%>" type="hidden"/>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>姓名：</td>
      <td class="layerright" width="35%"><input name="card.name" type="text" class="inputauto" /></td>
      <td class="layertdleft100">昵称：</td>
      <td class="layerright"><input name="card.nickName" type="text" class="inputauto" /></td>
    </tr>
    <tr>
      ...
      <tr>
          <td width="153">
			<input id="birthday" name="card.birthday" readonly="readonly" type="text" class="inputauto" onclick="return showCalendar('birthday');"/>
		</td>
				...
				<div class="divlays" style="margin: 0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td><label> <input id="mobile" name="card.mobile" type="text" class="input170" />
							</label></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input name="card.msn" type="text" class="input170" /></td>
						</tr>
					</table>
				</div>
			</div>
				...
				<div class="divlays" style="margin: 0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td><input name="card.companyAddr" type="text"
								class="input170" /></td>
						</tr>
						<tr>
							<td class="layertdleft100">单位电话：</td>
							<td><input name="card.officeTel" type="text"
								class="input170" /></td>
						</tr>
						<tr>
				...
				<div class="divlays" style="margin: 0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td><label> <input
									name="card.homeAddr" type="text" class="input170" />
							</label></td>
						</tr>
						<tr>
							<td class="layertdleft100">家庭邮编：</td>
							<td><label> <input name="card.zipcode" type="text"
									class="input170" />
							</label></td>
						</tr>
						<tr>
							<td class="layertdleft100">配偶：</td>
							<td><input name="card.spouse" type="text"
								class="input170" /></td>
						</tr>
						<tr>
							<td class="layertdleft100">子女：</td>
							<td><input name="card.child" type="text"
								class="input170" /></td>
						</tr>
					</table>
				</div>
