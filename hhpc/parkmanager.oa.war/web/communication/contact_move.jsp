...
<script type="text/javascript">
	...
	function moveSelected() {
		...
		if(moveIds==""){
			...
			$.ajax({
				  url:"<%=basePath%>card!moveCard.action?ids=${param.ids}&moveIds="+moveIds,
				  type:"POST",
				  contentType:"application/json; charset=utf-8",
				  dataType:"json",
				  success: function(data){
					  if(data.flag){
						  showTip("不能移动公共名片",2000);
...
<div class="buttondiv">
	<a href="javascript:void(0)" title="" class="btn_bg" onclick="moveSelected()"><span><img src="core/common/images/accept.png">确认</span></a>
