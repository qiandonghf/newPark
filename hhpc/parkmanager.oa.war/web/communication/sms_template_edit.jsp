...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright">
      	<input id="smsTemplate.id" name="smsTemplate.id" type="hidden" value="${result.value.id}"/>
      	<input id="smsTemplate.name" name="smsTemplate.name" type="text" class="inputauto" value="${result.value.name}"/>
      </td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>模板内容：</td>
      <td ><span class="layerright">
      	<textarea id="smsTemplate.content" name="smsTemplate.content" style="height:150px;" class="textareaauto" >${result.value.content}</textarea>
      </span></td>
    </tr>
  </table>
</div>
