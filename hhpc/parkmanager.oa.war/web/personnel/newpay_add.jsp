...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>salaryItem!save.action">
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
	<!--//titlebg-->
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><label>
        <input name="salaryItem.name" type="text" class="inputauto" />
      </label></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>缺省值：</td>
      <td class="layerright"><label>
        <input name="salaryItem.defaultVal" type="text" class="inputauto" />
      </label></td>
    </tr>
  </table>
</div>
