		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean add = OaActivator.getHttpSessionService().isInResourceMap("oa_position_add");
					boolean edit = OaActivator.getHttpSessionService().isInResourceMap("oa_position_edit");
					boolean delete = OaActivator.getHttpSessionService().isInResourceMap("oa_position_del");
					boolean view = OaActivator.getHttpSessionService().isInResourceMap("oa_position_view");
					%>
					<%if(view){%>
