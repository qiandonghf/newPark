  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><label>
        <input name="salaryItem.name" type="text" class="inputauto" value="${result.value.name}"/>
        <input type="hidden" name="salaryItem.id" value="${result.value.id}"/>
      </label></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>缺省值：</td>
      <td class="layerright"><label>
        <input name="salaryItem.defaultVal" type="text" class="inputauto" value="<fmt:formatNumber value="${result.value.defaultVal}" pattern="#0.00"/>"/>
      </label></td>
    </tr>
  </table>
</div>
