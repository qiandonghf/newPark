...
<script type="text/javascript">
	...
	function onUploadSuccess(file, data, response) {
		$("#photo").val("core/resources/"+$.parseJSON(data).path);
		$("#archives_imagery_img").attr("src", "core/resources/"+$.parseJSON(data).path);
	}
				
	function removeImagery() {
		var userImagery = $("#archives_imagery_img").attr("src");
		$("#archives_imagery_img").attr("src", userImagery + "-d");
		$("#archives_imagery").val("core/common/images/locking.jpg");
...
<form id="form1" name="form1" method="post" action="<%=basePath%>archives!save.action">
<!--basediv-->
<div class="basediv">
<!--titlebg-->
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="30%" class="layerright"><input name="archives.serialNo" type="text" class="inputauto" /></td>
        <td class="layertdleft100"><span class="psred">*</span>员工姓名：</td>
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="200"><input id="username" name="archives.name" class="inputauto" type="text" /></td>
			</tr>
		</table></td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="psred">*</span>身份证号：</td>
        <td class="layerright"><label><input name="archives.idNo" type="text" class="inputauto" /></label></td>
        <td class="layertdleft100"><span class="psred">*</span>宗教信仰：</td>
        <td class="layerright">  		
    		<dd:select id="religiousId" name="archives.religiousId" key="oa.0004"/>
    	</td>
      </tr>
      <tr>
        ...
        <td class="layerright">
			...
			<tr>
				<td width="200"><input id="birthDay" name="archives.birthDay" type="text" class="inputauto" readonly="readonly" onclick="return showCalendar('birthDay','y-mm-dd');"/></td>
        ...
        <td class="layerright">  		
    		<dd:select id="politicalId" name="archives.politicalId" key="oa.0005"/>
    	</td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="psred">*</span>性别：</td>      
        <td class="layerright"><enum:select name="archives.gender" type="com.wiiy.commons.preferences.enums.GenderEnum"/></td>
        <td class="layertdleft100"><span class="psred">*</span>国籍：</td>
       	<td class="layerright">  		
    		<dd:select id="nationalityId" name="archives.nationalityId" key="oa.0006"/>
    	</td>
      </tr>
      <tr>
        <td class="layertdleft100">婚姻状况：</td>
        <td class="layerright"><enum:select name="archives.marriage" type="com.wiiy.commons.preferences.enums.BooleanEnum"/></td>
        <td class="layertdleft100"><span class="psred">*</span>民族：</td>
        <td class="layerright">  		
    		<dd:select id="ethnicId" name="archives.ethnicId" key="oa.0007"/>
    	</td>
      </tr>
      <tr>
        <td class="layertdleft100">籍贯：</td>
        <td class="layerright"><input name="archives.homeTown" type="text" class="inputauto" /></td>
        <td class="layertdleft100"><span class="psred">*</span>状态:</td>
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
	      <td width="118">
	        <enum:select name="archives.status" type="com.wiiy.oa.preferences.enums.PositionConditionEnum"/>
	      </td>
	     </tr>
	    </table></td>
      </tr>
    ...
    <td width="175" valign="top"><table style=" padding-top:3px;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="110"><img id="archives_imagery_img" class="oa_img" src="core/common/images/topxiao.gif" width="110" height="123" /></td>
            ...
            <td valign="top">
            	...
            	<input id="photo" type="hidden" name="archives.photo"/>	
           	</td>
          </tr>
     </table></td>
  </tr>
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
				<td width="200"><input id="orgId" name="archives.orgId" type="hidden" /><input id="orgName" name="orgName" class="inputauto" readonly="readonly" onclick="fbStart('选择部门','<%=BaseAction.rootLocation %>/core/org!select.action',520,400);"/></td>
       ...
       <%--  <td class="layertdleft100"><span class="psred">*</span>职位：</td>
        <td class="layerright"><select name="archives.positionId" class="selectauto">
      ...
      <tr>
        ...
        <td class="layerright"><label><input name="archives.position" type="text" class="inputauto" /></label></td>
       <%--  <td class="layertdleft100"><span class="psred">*</span>薪资标准单名称：</td>
        <td class="layerright">
	  ...
	  <tr>
        ...
        <td class="layerright">
			<table border="0" cellspacing="0" cellpadding="10">
			<tr>
				<td width="200"><input id="entryTime" name="archives.entryTime" type="text" class="inputauto" readonly="readonly" onclick="return showCalendar('entryTime','y-mm-dd');"/></td>
      ...
      <td class="layertdleft100">合同期限：</td>
        <td class="layerright">
	        <table  border="0" cellspacing="0" cellpadding="10">
	          <tr>
	            <td width="90">
	            	<input id="startTime" name="archives.startTime" class="data inputauto" onclick="return showCalendar('startTime')"/>
	            </td>
	            <td width="20">
	            ...
	            <td>--</td>
	            <td width="90">
	            		<input id="endTime" class="data inputauto" name="archives.endTime" onclick="return showCalendar('endTime')"/>
	            </td>
	            <td width="20">
      ...
      <tr>
        ...
        <td class="layerright"><input name="archives.bank" type="text" class="inputauto" /></td>
       <!--  <td class="layertdleft100">薪资标准编号：</td>
        <td class="layerright">
      ...
      <tr>
        <td class="layertdleft100">银行账号：</td>
       	<td class="layerright"><input name="archives.bankAccount" type="text" class="inputauto" /></td>
      <!--   <td class="layertdleft100">薪资标准金额：</td>
        <td class="layerright">
      ...
      <tr>
        ...
        <td colspan="3" class="layerright"><textarea name="archives.train" rows="4" class="textareaauto"></textarea></td>
        </tr>
    </table></td>  
  </tr>
</table>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="30%" class="layerright">
          <input name="archives.homeAddr" type="text" class="inputauto" />
        </td>
        <td class="layertdleft100">电话号码：</td>
        <td width="30%" class="layerright"><input name="archives.phone" type="text" class="inputauto" /></td>
      </tr>
      <tr>
        <td class="layertdleft100">家庭邮编：</td>
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><input name="archives.zipCode" type="text" class="inputauto" /></td>
          </tr>
        </table></td>
        <td class="layertdleft100">QQ号码：</td>
        <td width="30%" class="layerright"><input name="archives.qq" type="text" class="inputauto" /></td>
      </tr>
      <tr>
        <td class="layertdleft100">手机号码：</td>
        <td width="30%" class="layerright"><input name="archives.mobile" type="text" class="inputauto" /></td>
        <td class="layertdleft100">电子邮箱：</td>
        <td width="30%" class="layerright"><input name="archives.email" type="text" class="inputauto" /></td>
      </tr>
    </table></td>
  </tr>
</table>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="layertdleft100">学历：</td>
       	<td class="layerright"><input name="archives.degree" type="text" class="inputauto" /></td>
        <td class="layertdleft100">毕业学校：</td>
        <td class="layerright"><input name="archives.school" type="text" class="inputauto" /></td>
      </tr>
      <tr>
        <td class="layertdleft100">专业：</td>
        <td class="layerright"><input name="archives.profession" type="text" class="inputauto"/></td>      
        <td class="layertdleft100">参加工作时间：</td>
        <td class="layerright"><input name="archives.workTime" type="text" class="inputauto" /></td>
      </tr>
      <tr>
        <td valign="top" class="layertdleft100">教育背景：</td>
        <td colspan="3" valign="top"><label><span class="layerright">
          <textarea name="archives.education" rows="8" class="textareaauto"></textarea>
        </span></label></td>
        </tr>
    </table></td>
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td colspan="3" valign="top"><label><span class="layerright">
          <textarea name="archives.rewards" rows="6" class="textareaauto"></textarea>
        </span></label></td>
        <td valign="top" class="layertdleft100">工作经验：</td>
        <td colspan="3" valign="top"><label><span class="layerright">
          <textarea name="archives.experience" rows="6" class="textareaauto"></textarea>
        </span></label></td>
      </tr> 
      <tr>
        <td valign="top" class="layertdleft100">个人爱好：</td>
        <td colspan="3" valign="top"><label><span class="layerright">
          <textarea name="archives.hobby" rows="6" class="textareaauto"></textarea>
        </span></label></td>
        <td valign="top" class="layertdleft100">备注：</td>
        <td colspan="3" valign="top"><label><span class="layerright">
          <textarea name="archives.memo" rows="6" class="textareaauto"></textarea>
        </span></label></td>
      </tr>    
    </table></td>
