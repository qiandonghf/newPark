...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>workSchedule!update.action">
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="170"><label>
          <input name="workSchedule.id" type="hidden" value="${result.value.id}"/>
          <input name="workSchedule.name" type="text" class="inputauto" value="${result.value.name}"/>
        </label></td>
      </tr>
      <tr>
        <td class="layertdleft100"><span class="psred">*</span>是否缺省：</td>
        <td class="layerright"><label>
        	<enum:radio name="workSchedule.isDefault" type="com.wiiy.commons.preferences.enums.BooleanEnum" checked="result.value.isDefault"/>
        </label></td>
      </tr>
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="150">
            	<input type="hidden" name="workSchedule.day7" id="day7" value="${result.value.day7}"/>
            	<input name="day7Class" type="text" class="inputauto" id="showOnly7" readonly="readonly" value="${day7Class}"/>
            </td>
      ...
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="150">
            	<input name="workSchedule.day1" type="hidden" id="day1" value="${result.value.day1}"/>
            	<input name="day1Class" type="text" class="inputauto" id="showOnly1" readonly="readonly" value="${day1Class}"/>
            </td>
      ...
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="150">
	            <input name="workSchedule.day2" type="hidden" id="day2" value="${result.value.day2}"/>
	            <input name="day2Class" type="text" class="inputauto" id="showOnly2" readonly="readonly" value="${day2Class}"/>
            </td>
      ...
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="150">
            <input name="workSchedule.day3" type="hidden" id="day3" value="${result.value.day3}"/>
            <input name="day3Class" type="text" class="inputauto" id="showOnly3" readonly="readonly" value="${day3Class}"/>
            </td>
      ...
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="150">
            	<input name="workSchedule.day4" type="hidden" id="day4" value="${result.value.day4}"/>
            	<input name="day4Class" type="text" class="inputauto" id="showOnly4" readonly="readonly" value="${day4Class}"/>
            </td>
      ...
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="150">
            	<input name="workSchedule.day5" type="hidden" id="day5" value="${result.value.day5}"/>
            	<input name="day5Class" type="text" class="inputauto" id="showOnly5" readonly="readonly" value="${day5Class}"/>
            </td>
      ...
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="150">
            	<input name="workSchedule.day6" type="hidden" id="day6" value="${result.value.day6}"/>
            	<input name="day6Class" type="text" class="inputauto" id="showOnly6" readonly="readonly" value="${day6Class}"/>
            </td>
