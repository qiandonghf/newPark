...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>workClass!save.action">
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
	<!--//titlebg-->
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><input name="workClass.name" type="text" class="input170" /></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>上班时间：</td>
      <td class="layerright"><select name="startTimeHour">
      	<option value="">---</option>
    ...
    <tr>
      ...
      <td class="layerright"><label>
        <textarea name="workClass.memo" rows="5" class="textareaauto"></textarea>
      </label></td>
    </tr>
  </table>
</div>
