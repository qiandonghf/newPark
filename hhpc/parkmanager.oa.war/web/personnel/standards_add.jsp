...
<script type="text/javascript">
			...
			submitHandler: function(form){
				$('#form1').ajaxSubmit({ 
			        ...
			        success: function(data){
		        		...
		        		//alert(data.result.value.id);		        
		        		$("#saId").val(data.result.value.id);		        		
		        	} 
			    });
			}
		});
	...
	function initList(){
		...
		$("#list").jqGrid({
	    	url:'<%=basePath%>salaryDefineCfg!list.action',
			colModel: [
	...
	function reloadSalaryDefineCfgList(sid){
		//级联页面刷新，重新修改URL请求参数,会将salaryDefineId当作参数附在url后
...
<body >
<form id="form1" name="form1" method="post" action="<%=basePath%>salaryDefine!save.action">
<!--basediv-->
<div class="basediv">
<!--titlebg-->
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="820"><input id="serialNo" name="salaryDefine.serialNo"  type="text" class="inputauto" /></td>
      ...
      <tr>
        ...
        <td class="layerright"><label>
          <input name="salaryDefine.name"  type="text" class="inputauto" />
        </label></td>
        </tr>
      <tr>
        <td class="layertdleft100">备注：</td>
        <td class="layerright"><textarea name="salaryDefine.memo" rows="8" class="textareaauto"></textarea></td>
        </tr>
    </table></td>  
  </tr>
</table>
...
<div class="emailtop">
	<div class="leftemail">
		...
		<ul>
			<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('薪酬项目列表','<%=basePath%>salaryDefine!config.action?id='+$('#saId').val(),589,247);"><span><img src="core/common/images/emailadd.gif"/></span>设置</li>
