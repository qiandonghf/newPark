...
<script type="text/javascript">
	...
	function uploadSuccess(file, data, response){
		...
		var postData = {"contractRecordAtt.name":file.originalName,"contractRecordAtt.newName":file.path,"contractRecordAtt.size":file.size};
		$.post("<%=basePath%>contractRecordAtt!saveToSession.action",postData,function(callbackData){
	...
	function deleteAtt(id){
		$.post("<%=basePath %>contractRecordAtt!deleteFromSession.action?id="+id,function(data){
			$("#li"+id).remove();
		});			
	}
	function initForm(){
...
<body>
<form action="<%=basePath %>contractRecord!save.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
	<!--//titlebg-->
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><input name="contractRecord.partya" type="text" class="inputauto"/></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>乙方：</td>
      <td class="layerright"><input name="contractRecord.partyb" type="text" class="inputauto"/></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>合同名称：</td>
      <td class="layerright"><input name="contractRecord.contractName" type="text" class="inputauto" /></td>
    </tr>
    <tr>
    ...
    <tr>
		...
		<td class="layerright">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><input name="contractRecord.signingDate" readonly="readonly" type="text" class="inputauto" id="signingDate" onclick="return showCalendar('signingDate');"/></td>
	...
	<tr>
      ...
      <td class="layerright"><enum:select type="com.wiiy.oa.preferences.enums.ContractCharacterEnum" name="contractRecord.contractCharacter" /></td>
    </tr>
	<tr>
      <td class="layertdleft100">金额：</td>
      <td class="layerright"><input name="contractRecord.money" type="text" class="inputauto" /></td>
    </tr>
    <tr>
