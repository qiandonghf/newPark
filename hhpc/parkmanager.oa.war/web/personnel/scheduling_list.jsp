		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean add = OaActivator.getHttpSessionService().isInResourceMap("oa_workArrange_add");
					boolean edit = OaActivator.getHttpSessionService().isInResourceMap("oa_workArrange_edit");
					boolean delete = OaActivator.getHttpSessionService().isInResourceMap("oa_workArrange_del");
					boolean view = OaActivator.getHttpSessionService().isInResourceMap("oa_workArrange_view");
					%>
					<%if(view){%>
