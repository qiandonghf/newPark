...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>sealApply!save.action">
  ...
  <table width="100%"  class="oatableAdd" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="150" class="oatabletdright" style="padding:2px 5px;">
      	 <input type="text" name="sealApply.applicant" class="inputauto" style="width:150px;" />
      </td>
    </tr>
	<tr>
	     ...
	     <td class="oatabletdright" style="padding:2px 5px;">
	     	<table width="50%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><input id="regTime" name="sealApply.applyTime" type="text" class="inputauto" onclick="showCalendar('regTime');"/></td>
    ...
    <tr>
    	...
    	<td  class="oatabletdright" style="padding:2px 5px;">
    		<input type="text" name="sealApply.project" class="inputauto" />
    	</td>
    </tr>
    <tr>
    	<td class="layertdleftblack"><span class="psred">*</span>用印名称：</td>
    	<td class="oatabletdright" style="padding:2px 5px;">
    		<input type="text" name="sealApply.name" class="inputauto" style="width:150px;" />
    	</td>
    </tr>
   	<tr>
   		<td class="layertdleftblack">用印数量：</td>
   		<td  class="oatabletdright" style="padding:2px 5px;">
   			<input type="text" name="sealApply.cnt" class="inputauto" style="width:150px;" />
   		</td>
   	</tr>
   	<tr>
    	<td class="layertdleftblack"><span class="psred">*</span>申请内容：</td>
    	<td  class="oatabletdright" style="padding:2px 5px;">
			<textarea name="sealApply.content" class="textareaauto" style="width:400px; height:80px;"></textarea>
		</td>
    </tr>
  </table>
</div>
...
<div class="buttondiv">
	  ...
	  <label><input name="Submit" type="submit" class="" value="保存并送审" onclick="$('#approval').val(1)"/></label>
