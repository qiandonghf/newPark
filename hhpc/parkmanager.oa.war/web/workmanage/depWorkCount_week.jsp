...
<script type="text/javascript">
 $(document).ready(function(){
	...
	boolean dayReport = OaActivator.getHttpSessionService().isInResourceMap("oa_department_viewDayReportList");
	boolean weekReport = OaActivator.getHttpSessionService().isInResourceMap("oa_department_viewWeekReportList");
	boolean monthReport = OaActivator.getHttpSessionService().isInResourceMap("oa_department_viewMonthReportList");
	%>
});
