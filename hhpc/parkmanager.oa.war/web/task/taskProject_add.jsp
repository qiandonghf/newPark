...
<body>
<form action="<%=basePath %>taskProject!save.action" method="post" name="form1" id="form1">
<div class="basediv">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="layerright"><label>
        	<input name="taskProject.id" type="hidden" class="inputauto" value=""/>
        	<input name="taskProject.name" type="text" class="inputauto" value=""/>
        </label></td>
      </tr>
    </table>
	</div>
