...
<script>
	...
	var docFolderMenu=[
		...
		<%
			boolean flag = false;
			if(OaActivator.getHttpSessionService().isInResourceMap("oa_share_reName")){
				flag = true;
		%>
		 	{text:"重命名",
		 ...
		 <%}%>
		<%if(OaActivator.getHttpSessionService().isInResourceMap("oa_share_del")){
			if(flag){
		%>
		   ,
		<%}
		...
		<%}%>
		<%if(OaActivator.getHttpSessionService().isInResourceMap("oa_share_move")){
			if(flag){
		%>
		   ,
		<%}
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="100%" valign="top">
		<div>
			<iframe src="parkmanager.oa/web/document/share_document_index.jsp" frameborder="0" id="msglist" width="100%"></iframe>
		</div>
	  </td>
    </tr>
  </table>
