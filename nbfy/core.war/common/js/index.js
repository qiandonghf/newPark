...
function initHeight() {
	var heigth = document.documentElement.clientHeight - 118;
	var subNavHeigth = document.documentElement.clientHeight - 144;
	var width = document.documentElement.clientWidth - 210;
	$("#subnav").css("height",subNavHeigth);
	$("#subscroll").css("height",heigth);
	$("#tt").css("height",heigth);
	$("#tt").css("width",width);
}
