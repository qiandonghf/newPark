...
public class InvestmentServiceImpl implements InvestmentService{
	...
	public Result submitSettled(Long id) {
		...
		try {
			...
			customer.setCode(generateCode().getValue());
			...
			if(investment.getRegInfo()!=null){
				...
				User user = new User();
				String userName = investment.getName();
				if(investment.getAccount()!=null && !investment.getAccount().trim().equals("")){
					userName = investment.getAccount();
				}
