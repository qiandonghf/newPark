				...
				$('#form1').ajaxSubmit({ 
			        ...
			        success: function(data){
			        	...
			        	if(data.result.success){
			        		setTimeout("getOpener().reloadList('brand');parent.fb.end();", 2000);
			        	}
			        } 
			    });
			}
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright">${result.value.name}<input id="customerId" name="brand.customerId" type="hidden" value="${result.value.id}"/></td>
    </tr>
    <tr>
