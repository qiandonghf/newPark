...
<div class="pm_view_left">
	<ul>
		...
		<li <%if(index==2){%>class="overbg" style="border-top:none;"<%} else {%>class="pm_color"<%} %>><span><img src="parkmanager.pb/web/images/tipsico.png" /></span><a href="<%=basePath%>web/client/contectInfo_list_by_customerId_service.jsp?id=<%=request.getParameter("customerId") %>">交往信息</a></li>
		<%} %>
