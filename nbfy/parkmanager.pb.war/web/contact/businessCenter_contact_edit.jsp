...
<body>
<form action="<%=basePath %>businessCenterContact!update.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
<input type="hidden" id="id" name="businessCenterContact.id" value="${result.value.id }" />
				...
				<div class="divlays" style="margin:0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="layerright"><table width="30%" border="0" cellspacing="0" cellpadding="0">
       						 <tbody><tr>
							          ...
							          <input id="orgId" value="${result.value.orgId }" name="businessCenterContact.orgId" type="hidden" ><input id="org" ${result.value.org } name="businessCenterContact.org" value="${result.value.org }" class="inputauto" onclick="selectOrg()" readonly="readonly"></td>
						...
						<tr>
							...
							<td colspan="3" class="layerright" style="padding-top:2px;"> <textarea name="businessCenterContact.content"  class="textareaauto"  rows="4">${result.value.content }</textarea></td>
						</tr>
					</table>
				</div>
