...
<body>
<form action="<%=basePath %>tenementCenterContact!save.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
				...
				<div class="divlays" style="margin:0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="layerright"><table width="60%" border="0" cellspacing="0" cellpadding="0">
       						 <tbody><tr>
							          ...
							          <input id="customerId" name="tenementCenterContact.customerId" type="hidden" /><input id="customer" name="tenementCenterContact.customer" class="inputauto" onclick="selectCustomer()" readonly="readonly"/></td>
						...
						<tr>
							...
							<td class="layerright">
								<table width="60%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
										<input type="hidden" name="tenementCenterContact.roomId" id="roomId"  />
						...
						<tr>
							...
							<td colspan="3" class="layerright" style="padding-top:2px;"> <textarea name="tenementCenterContact.content"  class="textareaauto"  rows="4"></textarea></td>
						</tr>
					</table>
				</div>
