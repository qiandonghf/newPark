...
<script type="text/javascript">
	...
	function uploadSuccess(file, data, response){
		...
		var postData = {"contractAgreementAtt.name":file.originalName,"contractAgreementAtt.newName":file.path,"contractAgreementAtt.size":file.size};
		$.post("<%=basePath%>contractAgreementAtt!saveToSession.action",postData,function(callbackData){
	...
	function deleteAtt(id){
		$.post("<%=basePath %>contractAgreementAtt!deleteFromSession.action?id="+id,function(data){
			$("#li"+id).remove();
		});			
	}
	function initForm(){
...
<body>
<form action="<%=basePath %>contractAgreement!save.action" method="post" name="form1" id="form1">
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
	<!--//titlebg-->
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><input size="60" id="contractName" name="contractAgreement.contractName" type="text" class="inputauto" /></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>客户名称：</td>
      <td class="layerright"><input id="customerName" name="contractAgreement.customerName" type="text" class="inputauto" /></td>
    </tr>
    <tr>
      ...
      <td class="layerright"><table width="205" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="180"><input name="contractAgreement.startDate" readonly="readonly" type="text" class="inputauto" id="startDate" onclick="return showCalendar('startDate');" /></td>
    ...
    <tr>
      ...
      <td class="layerright"><table width="205" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="180"><input name="contractAgreement.endDate" readonly="readonly" type="text" class="inputauto" id="endDate" onclick="return showCalendar('endDate');" /></td>
    ...
    <tr>
      ...
      <td class="layerright"><table width="205" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="180"><input name="contractAgreement.signingDate" readonly="readonly" type="text" class="inputauto" id="signingDate" onclick="return showCalendar('signingDate');" /></td>
    ...
    <tr>
      ...
      <textarea name="contractAgreement.comment" style=" height:80px;" class="textareaauto" id="comment"></textarea>
      </label></td>
    </tr>
    <tr>
