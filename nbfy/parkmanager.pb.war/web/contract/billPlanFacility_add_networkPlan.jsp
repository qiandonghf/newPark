		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="layerright">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100"><input readonly="readonly" id="startDate" name="billPlanFacility.startDate" type="text" class="inputauto" onclick="showCalendar('startDate')"/></td>
							...
							<td width="18">—</td>
							<td width="100" align="center"><input readonly="readonly" id="endDate" name="billPlanFacility.endDate" type="text" class="inputauto" onclick="showCalendar('endDate')"/></td>
			...
			<tr>
				...
				<td class="layerright">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100"><input readonly="readonly" id="planPayDate" name="billPlanFacility.planPayDate" type="text" class="inputauto" onclick="showCalendar('planPayDate')"/></td>
