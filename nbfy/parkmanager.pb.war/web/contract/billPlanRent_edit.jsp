	...
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="layerright"><enum:select id="feeType" checked="result.value.feeType" type="com.wiiy.crm.preferences.enums.RentBillPlanFeeEnum" name="billPlanRent.feeType"/></td>
			</tr>
			<tr>
			...
			<%-- <tr>
				...
				<td class="layerright">
					<enum:select type="com.wiiy.crm.preferences.enums.BillPlanStatusEnum" checked="result.value.status" name="billPlanRent.status"/>
				</td>
			</tr> --%>
			<tr>
				<td class="layertdleft100">备注：</td>
				<td class="layerright"><textarea name="billPlanRent.memo" class="textareaauto" style="height:50px;">${result.value.memo}</textarea></td>
			</tr>
		</table>
	</div>
