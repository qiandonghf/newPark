...
<title>无标题文档</title>
	...
	<script type="text/javascript">
		...
		function appendBillPlanRent(obj){
			...
			var status = $("<input />",{name:"planStatus",type:"hidden",value:obj.get("status")}).addClass("planStatus");
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
			...
			<% 
      		...
      		%>
			<td class="layerright"><input name="contract.address" type="text" class="inputauto" style="width:99%;" value="<%=address %>" /></td>
    	...
    	<tr>
			...
			<td class="layerright"><input name="contract.purpose" type="text" class="inputauto" style="width:99%;" /></td>
			<td class="layertdleft100">装修期：</td>
			<td class="layerright"><table border="0" cellspacing="0" cellpadding="10">
				<tbody>
					<tr>
			            <td width="80"><input id="decorateStartDate" name="contract.decorateStartDate" type="text" readonly="readonly" class="inputauto" onclick="showCalendar('decorateStartDate');" /></td>
			            ...
			            <td>&nbsp;至&nbsp;</td>
			            <td width="80"><input id="decorateEndDate" name="contract.decorateEndDate" type="text" readonly="readonly" class="inputauto" onclick="showCalendar('decorateEndDate');" /></td>
    	...
    	<tr>
			<td class="layertdleft100">租金支付方式：</td>
			<td class="layerright">
				<enum:select type="com.wiiy.crm.preferences.enums.RentBillPlanEnum" name="contract.payType"/>
			</td>
