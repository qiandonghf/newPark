		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="layerright"><enum:select id="type" checked="result.value.type" type="com.wiiy.crm.preferences.enums.DepositTypeEnum" name="deposit.type"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="layerright"><textarea name="deposit.memo" rows="5" class="textareaauto">${result.value.memo}</textarea></td>
				</tr>
			</table>
		</div>
