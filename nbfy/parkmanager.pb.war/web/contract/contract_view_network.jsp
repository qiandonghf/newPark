...
<div class="basediv">
	<div class="emailtop">
		<div class="leftemail">
			<ul>
				...
				<li onclick="approval(${result.value.id})" onmouseover="this.className='libg'" onmouseout="this.className=''"><span><img src="core/common/images/examine.png"/></span>送审</li>
	...
	<div class="divlays">
		...
		<div style="height: 230px;">
			...
			<jsp:include page="contract_bottom_common_network.jsp"></jsp:include>
