									...
									<tbody>
										<tr>
											...
											<td width="90" style="padding-left: 3px;padding-right: 3px;">
												<search:choose dataType="com.wiiy.pb.preferences.enums.FacilityTypeEnum" field="facility.type" op="eq">
												<enum:select type="com.wiiy.pb.preferences.enums.FacilityTypeEnum" styleClass="data"/>
												</search:choose>
											</td>
