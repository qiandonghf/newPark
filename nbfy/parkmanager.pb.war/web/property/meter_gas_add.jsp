...
<input type="hidden" name="meter.type" value="GAS"/>
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="layertdleft100"><span class="redweight">*</span>气表名称：</td>
      <td><input name="meter.name" type="text" class="input170" /></td>
      <td class="layertdleft100"><span class="redweight">*</span>气表倍数：</td>
      <td><input name="meter.meterFactor" type="text" class="input170" /></td>
      </tr>
    <tr>
      <td class="layertdleft100"><span class="redweight">*</span>气表编号：</td>
    ...
    <tr>
      <td class="layertdleft100">气表序列号：</td>
    ...
    <tr>
      ...
      <td class="layertdleft100"><span class="redweight">*</span>气表性质：</td>
      <td class="layerright">
    ...
    <tr>
      ...
      <td class="layertdleft100"><span class="redweight">*</span>气表状态：</td>
      <td class="layerright">
