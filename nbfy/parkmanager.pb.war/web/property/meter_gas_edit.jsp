  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td><input id="parentNo" name="meter.parentNo" type="text" class="inputauto" value="${meter.parentNo}" onclick="fbStart('选择母表编号','<%=basePath%>web/property/meter_select2.jsp?id=${meter.parentId}&orderNo=${meter.parentNo}',520,420);"/></td>
    ...
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><input id="readingDate" name="meter.readingDate" type="text" class="inputauto" onclick="return showCalendar('readingDate', 'y-mm-dd');"  value="<fmt:formatDate value="${meter.readingDate}" pattern="yyyy-MM-dd"/>"/></td>
    ...
    <tr>
      ...
      <td><input name="meter.preReading" type="text" class="input170" value="${meter.preReading}"/></td>
